...
<div class="container">
    ...
    <div class="row">
        ...
        <section id="learn-leader" class="span7">
			...
			OCaml is a general purpose industrial-strength programming language with an emphasis on expressiveness and safety. It is the technology of choice in <a href="companies.html">companies</a> where a single mistake can cost millions and speed matters, and there is an <a href="/community/">active community</a> that has developed a <a href="https://opam.ocaml.org/packages/">rich set of libraries</a>. <small><em><a href="description.html">Read more</a></em></small>.</p>
        </section>
