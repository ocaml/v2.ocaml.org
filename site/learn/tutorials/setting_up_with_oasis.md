...
`BuildDepends` is a comma separated list of ocamlfind packages. [ocamlfind](http://ocaml.org/learn/tutorials/dev_tools.html#Findlibocamlfind) handles packages locally in your system and is used by opam. You can list ocamlfind packages with `ocamlfind list`.
...
OASIS uses [ocamlbuild](http://ocaml.org/learn/tutorials/dev_tools.html#ocamlbuild) as underlying build system. This has several consequences.
