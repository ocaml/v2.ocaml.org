...
<td><div class="info">
Same as <a href="List.html#VALassoc"><code class="code"><span class="constructor">List</span>.assoc</code></a>, but uses physical equality instead of
...
<td><div class="info">
Same as <a href="List.html#VALassoc_opt"><code class="code"><span class="constructor">List</span>.assoc_opt</code></a>, but uses physical equality instead of
   structural equality to compare keys.
</div>
</td></tr>
...
<code class="code"><span class="constructor">Scanning</span>.beginning_of_input&nbsp;ic</code> tests the beginning of input condition
    of the given <a href="Scanf.Scanning.html#TYPEin_channel"><code class="code"><span class="constructor">Scanf</span>.<span class="constructor">Scanning</span>.in_channel</code></a> formatted input channel.
</div>
</td></tr>
...
<td></td></tr>
<tr><td><a href="Num.html#VALbig_int_of_num_opt">big_int_of_num_opt</a> [<a href="Num.html">Num</a>]</td>
<td><div class="info">
</div>
</td></tr>
...
<tr><td><a href="Big_int.html#VALbig_int_of_string_opt">big_int_of_string_opt</a> [<a href="Big_int.html">Big_int</a>]</td>
<td><div class="info">
Convert a string to a big integer, in decimal.
</div>
</td></tr>
...
<code class="code"><span class="constructor">Genarray</span>.change_layout&nbsp;a&nbsp;layout</code> returns a bigarray with the
      ...
      the same dimensions as <code class="code">a</code>).
</div>
</td></tr>
...
<td><div class="info">
Closes the <a href="Pervasives.html#TYPEin_channel"><code class="code">in_channel</code></a> associated with the given
  <a href="Scanf.Scanning.html#TYPEin_channel"><code class="code"><span class="constructor">Scanf</span>.<span class="constructor">Scanning</span>.in_channel</code></a> formatted input channel.
</div>
</td></tr>
...
<td><div class="info">
<code class="code">compare&nbsp;u&nbsp;u'</code> is <code class="code"><span class="constructor">Pervasives</span>.compare&nbsp;u&nbsp;u'</code>.
</div>
</td></tr>
...
<td><div class="info">
Same as <a href="Array.html#VALappend"><code class="code"><span class="constructor">Array</span>.append</code></a>, but concatenates a list of arrays.
</div>
</td></tr>
...
<td><div class="info">
<code class="code">cons&nbsp;x&nbsp;xs</code> is <code class="code">x&nbsp;::&nbsp;xs</code>
</div>
</td></tr>
...
<td><div class="info">
<code class="code">create&nbsp;~path</code> creates a series file at <code class="code">path</code>.
</div>
</td></tr>
...
<td><div class="info">
Same as <a href="Ephemeron.K1.html#VALcreate"><code class="code"><span class="constructor">Ephemeron</span>.<span class="constructor">K1</span>.create</code></a>
</div>
</td></tr>
...
<td><div class="info">
<code class="code"><span class="constructor">Ephemeron</span>.<span class="constructor">K1</span>.create&nbsp;()</code> creates an ephemeron with one key.
</div>
</td></tr>
...
<tr><td><a href="Identifiable.S.Map.html#VALdata">data</a> [<a href="Identifiable.S.Map.html">Identifiable.S.Map</a>]</td>
<td></td></tr>
...
<td><div class="info">
<code class="code">delete_eol_spaces&nbsp;s</code> returns a fresh copy of <code class="code">s</code> with any end of
   line spaces removed.
</div>
</td></tr>
...
<code class="code">did_you_mean&nbsp;ppf&nbsp;get_choices</code> hints that the user may have meant
    one of the option returned by calling <code class="code">get_choices</code>.
</div>
</td></tr>
...
<tr><td><a href="Identifiable.S.Map.html#VALdisjoint_union">disjoint_union</a> [<a href="Identifiable.S.Map.html">Identifiable.S.Map</a>]</td>
<td><div class="info">
<code class="code">disjoint_union&nbsp;m1&nbsp;m2</code> contains all bindings from <code class="code">m1</code> and
        <code class="code">m2</code>.
</div>
</td></tr>
...
<code class="code">edit_distance&nbsp;a&nbsp;b&nbsp;cutoff</code> computes the edit distance between
    strings <code class="code">a</code> and <code class="code">b</code>.
</div>
</td></tr>
...
<tr><td><a href="Builtin_attributes.html#VALemit_external_warnings">emit_external_warnings</a> [<a href="Builtin_attributes.html">Builtin_attributes</a>]</td>
<td></td></tr>
...
<td><div class="info">
Return <code class="code">()</code> if the stream is empty, else raise <a href="Stream.html#EXCEPTIONFailure"><code class="code"><span class="constructor">Stream</span>.<span class="constructor">Failure</span></code></a>.
</div>
</td></tr>
...
<td><div class="info">
<code class="code">equal&nbsp;u&nbsp;u'</code> is <code class="code">u&nbsp;=&nbsp;u'</code>.
</div>
</td></tr>
...
<td><div class="info">
Same as <a href="List.html#VALsort"><code class="code"><span class="constructor">List</span>.sort</code></a> or <a href="List.html#VALstable_sort"><code class="code"><span class="constructor">List</span>.stable_sort</code></a>, whichever is
...
<code class="code">filter_map&nbsp;f&nbsp;l</code> applies <code class="code">f</code> to every element of <code class="code">l</code>, filters
        ...
        the <code class="code"><span class="constructor">Some</span></code> elements.
</div>
</td></tr>
<tr><td><a href="Identifiable.S.Map.html#VALfilter_map">filter_map</a> [<a href="Identifiable.S.Map.html">Identifiable.S.Map</a>]</td>
<td></td></tr>
...
<td><div class="info">
same as <a href="Gc.html#VALfinalise"><code class="code"><span class="constructor">Gc</span>.finalise</code></a> except the value is not given as argument.
</div>
</td></tr>
...
<code class="code">find_first_opt&nbsp;f&nbsp;m</code>, where <code class="code">f</code> is a monotonically increasing function,
       ...
       such that <code class="code">f&nbsp;k</code>, or <code class="code"><span class="constructor">None</span></code> if no such key exists.
</div>
</td></tr>
...
<code class="code">find_first_opt&nbsp;f&nbsp;s</code>, where <code class="code">f</code> is a monotonically increasing function,
       ...
       <code class="code">f&nbsp;e</code>, or <code class="code"><span class="constructor">None</span></code> if no such element exists.
</div>
</td></tr>
...
<td><div class="info">
<code class="code">find_opt&nbsp;t&nbsp;x</code> returns an instance of <code class="code">x</code> found in <code class="code">t</code>
        or <code class="code"><span class="constructor">None</span></code> if there is no such element.
</div>
</td></tr>
...
<code class="code">find_opt&nbsp;p&nbsp;l</code> returns the first element of the list <code class="code">l</code> that
    ...
    satisfies <code class="code">p</code> in the list <code class="code">l</code>.
</div>
</td></tr>
...
<code class="code"><span class="constructor">Hashtbl</span>.find_opt&nbsp;tbl&nbsp;x</code> returns the current binding of <code class="code">x</code> in <code class="code">tbl</code>,
    or <code class="code"><span class="constructor">None</span></code> if no such binding exists.
</div>
</td></tr>
...
<code class="code">find_opt&nbsp;x&nbsp;m</code> returns <code class="code"><span class="constructor">Some</span>&nbsp;v</code> if the current binding of <code class="code">x</code>
        in <code class="code">m</code> is <code class="code">v</code>, or <code class="code"><span class="constructor">None</span></code> if no such binding exists.
</div>
</td></tr>
...
<td><div class="info">
An alias for <code class="code">concat</code>.
</div>
</td></tr>
...
<td><div class="info">
Same as <code class="code">float_of_string</code>, but returns <code class="code"><span class="constructor">None</span></code> instead of raising.
</div>
</td></tr>
...
<code class="code">fold&nbsp;f&nbsp;accu&nbsp;s</code> is <code class="code">(f&nbsp;(...&nbsp;(f&nbsp;(f&nbsp;accu&nbsp;x1)&nbsp;x2)&nbsp;...)&nbsp;xn)</code>
    ...
    and <code class="code">xn</code> the bottom element.
</div>
</td></tr>
...
<td><div class="info">
<code class="code"><span class="constructor">Scanning</span>.from_channel&nbsp;ic</code> returns a <a href="Scanf.Scanning.html#TYPEin_channel"><code class="code"><span class="constructor">Scanf</span>.<span class="constructor">Scanning</span>.in_channel</code></a> formatted
...
<td><div class="info">
An alias for <a href="Scanf.Scanning.html#VALopen_in"><code class="code"><span class="constructor">Scanf</span>.<span class="constructor">Scanning</span>.open_in</code></a> above.
</div>
</td></tr>
<tr><td><a href="Scanf.Scanning.html#VALfrom_file_bin">from_file_bin</a> [<a href="Scanf.Scanning.html">Scanf.Scanning</a>]</td>
<td><div class="info">
An alias for <a href="Scanf.Scanning.html#VALopen_in_bin"><code class="code"><span class="constructor">Scanf</span>.<span class="constructor">Scanning</span>.open_in_bin</code></a> above.
</div>
</td></tr>
...
<td><div class="info">
<code class="code"><span class="constructor">Scanning</span>.from_function&nbsp;f</code> returns a <a href="Scanf.Scanning.html#TYPEin_channel"><code class="code"><span class="constructor">Scanf</span>.<span class="constructor">Scanning</span>.in_channel</code></a> formatted
...
<td><div class="info">
<code class="code"><span class="constructor">Scanning</span>.from_string&nbsp;s</code> returns a <a href="Scanf.Scanning.html#TYPEin_channel"><code class="code"><span class="constructor">Scanf</span>.<span class="constructor">Scanning</span>.in_channel</code></a> formatted
...
<td><div class="info">
See <a href="Unix.html#VALftruncate"><code class="code"><span class="constructor">Unix</span>.ftruncate</code></a>.
</div>
</td></tr>
...
<tr><td><a href="Timings.html#VALget">get</a> [<a href="Timings.html">Timings</a>]</td>
<td><div class="info">
...
<td><div class="info">
<code class="code"><span class="constructor">Array0</span>.get&nbsp;a</code> returns the only element in <code class="code">a</code>.
</div>
</td></tr>
...
<td><div class="info">
Same as <a href="Ephemeron.K1.html#VALget_data"><code class="code"><span class="constructor">Ephemeron</span>.<span class="constructor">K1</span>.get_data</code></a>
</div>
</td></tr>
...
<code class="code"><span class="constructor">Ephemeron</span>.<span class="constructor">K1</span>.get_data&nbsp;eph</code> returns <code class="code"><span class="constructor">None</span></code> if the data of <code class="code">eph</code> is
      empty, <code class="code"><span class="constructor">Some</span>&nbsp;x</code> (where <code class="code">x</code> is the data) if it is full.
</div>
</td></tr>
<tr><td><a href="Obj.Ephemeron.html#VALget_data_copy">get_data_copy</a> [<a href="Obj.Ephemeron.html">Obj.Ephemeron</a>]</td>
<td><div class="info">
Same as <a href="Ephemeron.K1.html#VALget_data_copy"><code class="code"><span class="constructor">Ephemeron</span>.<span class="constructor">K1</span>.get_data_copy</code></a>
</div>
</td></tr>
...
<td><div class="info">
Same as <a href="Ephemeron.K1.html#VALget_key"><code class="code"><span class="constructor">Ephemeron</span>.<span class="constructor">K1</span>.get_key</code></a>
</div>
</td></tr>
...
<code class="code"><span class="constructor">Ephemeron</span>.<span class="constructor">K1</span>.get_key&nbsp;eph</code> returns <code class="code"><span class="constructor">None</span></code> if the key of <code class="code">eph</code> is
      empty, <code class="code"><span class="constructor">Some</span>&nbsp;x</code> (where <code class="code">x</code> is the key) if it is full.
</div>
</td></tr>
...
<td><div class="info">
Same as <a href="Ephemeron.K1.html#VALget_key_copy"><code class="code"><span class="constructor">Ephemeron</span>.<span class="constructor">K1</span>.get_key_copy</code></a>
</div>
</td></tr>
...
<td><div class="info">
Return the value associated to a variable in the process
    environment or <code class="code"><span class="constructor">None</span></code> if the variable is unbound.
</div>
</td></tr>
...
<td><div class="info">
Find an entry in <code class="code">group</code> with the given group id.
</div>
</td></tr>
...
<td><div class="info">
Find an entry in <code class="code">group</code> with the given name.
</div>
</td></tr>
...
<td><div class="info">
Find an entry in <code class="code">hosts</code> with the given address.
</div>
</td></tr>
...
<td><div class="info">
Find an entry in <code class="code">hosts</code> with the given name.
</div>
</td></tr>
...
<td><div class="info">
Find an entry in <code class="code">protocols</code> with the given name.
</div>
</td></tr>
...
<td><div class="info">
Find an entry in <code class="code">passwd</code> with the given name.
</div>
</td></tr>
...
<td><div class="info">
Find an entry in <code class="code">passwd</code> with the given user id.
</div>
</td></tr>
...
<td><div class="info">
Find an entry in <code class="code">services</code> with the given name.
</div>
</td></tr>
...
<td><div class="info">
Returns <code class="code"><span class="keyword">true</span></code> if the user is able to create symbolic links.
</div>
</td></tr>
...
<td><div class="info">
<code class="code">hash&nbsp;u</code> associates a non-negative integer to <code class="code">u</code>.
</div>
</td></tr>
...
<code class="code"><span class="constructor">String</span>.index_opt&nbsp;s&nbsp;c</code> returns the index of the first
    ...
    <code class="code"><span class="constructor">None</span></code> if <code class="code">c</code> does not occur in <code class="code">s</code>.
</div>
</td></tr>
...
<code class="code">index_opt&nbsp;s&nbsp;c</code> returns the index of the first occurrence of byte <code class="code">c</code>
    in <code class="code">s</code> or <code class="code"><span class="constructor">None</span></code> if <code class="code">c</code> does not occur in <code class="code">s</code>.
</div>
</td></tr>
...
<tr><td><a href="Big_int.html#VALint32_of_big_int_opt">int32_of_big_int_opt</a> [<a href="Big_int.html">Big_int</a>]</td>
<td><div class="info">
Convert a big integer to a 32-bit integer.
</div>
</td></tr>
...
<tr><td><a href="Big_int.html#VALint64_of_big_int_opt">int64_of_big_int_opt</a> [<a href="Big_int.html">Big_int</a>]</td>
<td><div class="info">
Convert a big integer to a 64-bit integer.
</div>
</td></tr>
...
<tr><td><a href="Big_int.html#VALint_of_big_int_opt">int_of_big_int_opt</a> [<a href="Big_int.html">Big_int</a>]</td>
<td><div class="info">
Convert a big integer to a small integer (type <code class="code">int</code>).
</div>
</td></tr>
...
<td></td></tr>
<tr><td><a href="Num.html#VALint_of_num_opt">int_of_num_opt</a> [<a href="Num.html">Num</a>]</td>
<td><div class="info">
</div>
</td></tr>
...
<td><div class="info">
Same as <code class="code">int_of_string</code>, but returs <code class="code"><span class="constructor">None</span></code> instead of raising.
</div>
</td></tr>
...
<td><div class="info">
<code class="code">is_char&nbsp;u</code> is <code class="code"><span class="keyword">true</span></code> iff <code class="code">u</code> is a latin1 OCaml character.
</div>
</td></tr>
...
<tr><td><a href="Identifiable.S.Map.html#VALkeys">keys</a> [<a href="Identifiable.S.Map.html">Identifiable.S.Map</a>]</td>
<td></td></tr>
...
<td><div class="info">
<code class="code">kind_size_in_bytes&nbsp;k</code> is the number of bytes used to store
   an element of type <code class="code">k</code>.
</div>
</td></tr>
...
<td><div class="info">
<span class="deprecated">Return a copy of the argument, with all uppercase letters
...
<td><div class="info">
<span class="deprecated">Convert the given character to its equivalent lowercase character,
   using the ISO Latin-1 (8859-1) character set.
</span></div>
</td></tr>
...
<td><div class="info">
See <a href="Unix.html#VALlseek"><code class="code"><span class="constructor">Unix</span>.lseek</code></a>.
</div>
</td></tr>
...
<tr><td><a href="Identifiable.S.Tbl.html#VALmap">map</a> [<a href="Identifiable.S.Tbl.html">Identifiable.S.Tbl</a>]</td>
<td></td></tr>
<tr><td><a href="Identifiable.S.Set.html#VALmap">map</a> [<a href="Identifiable.S.Set.html">Identifiable.S.Set</a>]</td>
<td></td></tr>
...
<td><div class="info">
<code class="code">map&nbsp;f&nbsp;s</code> is the set whose elements are <code class="code">f&nbsp;a0</code>,<code class="code">f&nbsp;a1</code>...
</div>
</td></tr>
...
<code class="code"><span class="keyword">let</span>&nbsp;r1,&nbsp;r2&nbsp;=&nbsp;map2_prefix&nbsp;f&nbsp;l1&nbsp;l2</code>
        ...
        r1 is <code class="code"><span class="constructor">List</span>.map2&nbsp;f&nbsp;l1&nbsp;h1</code> and r2 is t2.
</div>
</td></tr>
...
<tr><td><a href="Identifiable.S.Map.html#VALmap_keys">map_keys</a> [<a href="Identifiable.S.Map.html">Identifiable.S.Map</a>]</td>
<td></td></tr>
...
<td><div class="info">
<code class="code">max</code> is U+10FFFF.
</div>
</td></tr>
...
<code class="code">mem&nbsp;x&nbsp;a</code> is true if and only if <code class="code">x</code> is equal
   to an element of <code class="code">a</code>.
</div>
</td></tr>
...
<tr><td><a href="Identifiable.S.Tbl.html#VALmemoize">memoize</a> [<a href="Identifiable.S.Tbl.html">Identifiable.S.Tbl</a>]</td>
<td></td></tr>
...
<td><div class="info">
<code class="code">min</code> is U+0000.
</div>
</td></tr>
...
<code class="code"><span class="constructor">Scanning</span>.name_of_input&nbsp;ic</code> returns the name of the character source
    for the given <a href="Scanf.Scanning.html#TYPEin_channel"><code class="code"><span class="constructor">Scanf</span>.<span class="constructor">Scanning</span>.in_channel</code></a> formatted input channel.
</div>
</td></tr>
...
<td></td></tr>
<tr><td><a href="Num.html#VALnat_of_num_opt">nat_of_num_opt</a> [<a href="Num.html">Num</a>]</td>
<td><div class="info">
</div>
</td></tr>
<tr><td><a href="Config.html#VALnative_c_compiler">native_c_compiler</a> [<a href="Config.html">Config</a>]</td>
<td></td></tr>
...
<tr><td><a href="Big_int.html#VALnativeint_of_big_int_opt">nativeint_of_big_int_opt</a> [<a href="Big_int.html">Big_int</a>]</td>
<td><div class="info">
Convert a big integer to a native integer.
</div>
</td></tr>
...
<tr><td><a href="Big_int.html#VALnum_bits_big_int">num_bits_big_int</a> [<a href="Big_int.html">Big_int</a>]</td>
<td><div class="info">
...
<tr><td><a href="Num.html#VALnum_of_string_opt">num_of_string_opt</a> [<a href="Num.html">Num</a>]</td>
<td><div class="info">
Convert a string to a number.
</div>
</td></tr>
...
<td><div class="info">
<code class="code">of_char&nbsp;c</code> is <code class="code">c</code> as an Unicode character.
</div>
</td></tr>
...
<td><div class="info">
<code class="code">of_int&nbsp;i</code> is <code class="code">i</code> as an Unicode character.
</div>
</td></tr>
<tr><td><a href="Targetint.html#VALof_int">of_int</a> [<a href="Targetint.html">Targetint</a>]</td>
<td><div class="info">
Convert the given integer (type <code class="code">int</code>) to a target integer
    (type <code class="code">t</code>), module the target word size.
</div>
</td></tr>
...
<td></td></tr>
<tr><td><a href="Identifiable.S.Tbl.html#VALof_list">of_list</a> [<a href="Identifiable.S.Tbl.html">Identifiable.S.Tbl</a>]</td>
<td></td></tr>
<tr><td><a href="Identifiable.S.Map.html#VALof_list">of_list</a> [<a href="Identifiable.S.Map.html">Identifiable.S.Map</a>]</td>
<td></td></tr>
<tr><td><a href="Identifiable.S.Set.html#VALof_list">of_list</a> [<a href="Identifiable.S.Set.html">Identifiable.S.Set</a>]</td>
<td></td></tr>
...
<tr><td><a href="Identifiable.S.Tbl.html#VALof_map">of_map</a> [<a href="Identifiable.S.Tbl.html">Identifiable.S.Tbl</a>]</td>
<td></td></tr>
...
<tr><td><a href="Identifiable.S.Map.html#VALof_set">of_set</a> [<a href="Identifiable.S.Map.html">Identifiable.S.Map</a>]</td>
<td></td></tr>
...
<td><div class="info">
Same as <code class="code">of_string</code>, but return <code class="code"><span class="constructor">None</span></code> instead of raising.
</div>
</td></tr>
...
<td><div class="info">
<code class="code"><span class="constructor">Scanning</span>.open_in&nbsp;fname</code> returns a <a href="Scanf.Scanning.html#TYPEin_channel"><code class="code"><span class="constructor">Scanf</span>.<span class="constructor">Scanning</span>.in_channel</code></a> formatted input
...
<td><div class="info">
<code class="code"><span class="constructor">Scanning</span>.open_in_bin&nbsp;fname</code> returns a <a href="Scanf.Scanning.html#TYPEin_channel"><code class="code"><span class="constructor">Scanf</span>.<span class="constructor">Scanning</span>.in_channel</code></a> formatted
    input channel for bufferized reading in binary mode from file <code class="code">fname</code>.
</div>
</td></tr>
...
<td></td></tr>
<tr><td><a href="Identifiable.S.Set.html#VALoutput">output</a> [<a href="Identifiable.S.Set.html">Identifiable.S.Set</a>]</td>
<td></td></tr>
...
<td><div class="info">
Same as <a href="Arg.html#VALparse_argv_dynamic"><code class="code"><span class="constructor">Arg</span>.parse_argv_dynamic</code></a>, except that the <code class="code">argv</code> argument is a
...
<td><div class="info">
Same as <a href="Arg.html#VALparse"><code class="code"><span class="constructor">Arg</span>.parse</code></a>, except that the <code class="code"><span class="constructor">Expand</span></code> arguments are allowed and
    the <a href="Arg.html#VALcurrent"><code class="code"><span class="constructor">Arg</span>.current</code></a> reference is not updated.
</div>
</td></tr>
...
<code class="code">peek&nbsp;q</code> returns the first element in queue <code class="code">q</code>, without removing
   it from the queue, or raises <a href="Queue.html#EXCEPTIONEmpty"><code class="code"><span class="constructor">Queue</span>.<span class="constructor">Empty</span></code></a> if the queue is empty.
</div>
</td></tr>
...
<code class="code">pop&nbsp;s</code> removes and returns the topmost element in stack <code class="code">s</code>,
   or raises <a href="Stack.html#EXCEPTIONEmpty"><code class="code"><span class="constructor">Stack</span>.<span class="constructor">Empty</span></code></a> if the stack is empty.
</div>
</td></tr>
...
<tr><td><a href="Format.html#VALpp_flush_formatter">pp_flush_formatter</a> [<a href="Format.html">Format</a>]</td>
<td><div class="info">
...
<td></td></tr>
<tr><td><a href="Warnings.html#VALprint">print</a> [<a href="Warnings.html">Warnings</a>]</td>
<td></td></tr>
<tr><td><a href="Timings.html#VALprint">print</a> [<a href="Timings.html">Timings</a>]</td>
<td><div class="info">
...
<td></td></tr>
<tr><td><a href="Identifiable.S.Map.html#VALprint">print</a> [<a href="Identifiable.S.Map.html">Identifiable.S.Map</a>]</td>
<td></td></tr>
<tr><td><a href="Identifiable.S.Set.html#VALprint">print</a> [<a href="Identifiable.S.Set.html">Identifiable.S.Set</a>]</td>
<td></td></tr>
...
<td></td></tr>
<tr><td><a href="Location.html#VALprint_error_prefix">print_error_prefix</a> [<a href="Location.html">Location</a>]</td>
<td></td></tr>
...
<tr><td><a href="Clflags.html#VALprint_timings">print_timings</a> [<a href="Clflags.html">Clflags</a>]</td>
<td></td></tr>
...
<td><div class="info">
A hook can use <code class="code">raise_unwrapped_hook_exn</code> to raise an exception that will
      not be wrapped into a <a href="Misc.html#EXCEPTIONHookExnWrapper"><code class="code"><span class="constructor">Misc</span>.<span class="constructor">HookExnWrapper</span></code></a>.
</div>
</td></tr>
...
<td><div class="info">
<code class="code"><span class="constructor">Arg</span>.read_arg&nbsp;file</code> reads newline-terminated command line arguments from
    file <code class="code">file</code>.
</div>
</td></tr>
<tr><td><a href="Arg.html#VALread_arg0">read_arg0</a> [<a href="Arg.html">Arg</a>]</td>
<td><div class="info">
Identical to <a href="Arg.html#VALread_arg"><code class="code"><span class="constructor">Arg</span>.read_arg</code></a> but assumes null character terminated command line
    arguments.
</div>
</td></tr>
...
<td><div class="info">
Same as <code class="code">read_int_opt</code>, but returs <code class="code"><span class="constructor">None</span></code> instead of raising.
</div>
</td></tr>
...
Return the given file name without its extension, as defined
    in <a href="Filename.html#VALextension"><code class="code"><span class="constructor">Filename</span>.extension</code></a>.
</div>
</td></tr>
...
<tr><td><a href="Identifiable.S.Map.html#VALrename">rename</a> [<a href="Identifiable.S.Map.html">Identifiable.S.Map</a>]</td>
<td></td></tr>
...
<td></td></tr>
<tr><td><a href="Timings.html#VALreset">reset</a> [<a href="Timings.html">Timings</a>]</td>
<td><div class="info">
...
<code class="code">rindex_from_opt&nbsp;s&nbsp;i&nbsp;c</code> returns the index of the last occurrence
    ...
    occur in <code class="code">s</code> before position <code class="code">i+1</code>.
</div>
</td></tr>
...
Return the value of the runtime parameters, in the same format
    as the contents of the <code class="code"><span class="constructor">OCAMLRUNPARAM</span></code> environment variable.
</div>
</td></tr>
...
<code class="code">save_and_close&nbsp;series</code> writes information into <code class="code">series</code> required for
      ...
      <code class="code">series</code> file.
</div>
</td></tr>
...
Same as <a href="Scanf.html#VALbscanf"><code class="code"><span class="constructor">Scanf</span>.bscanf</code></a>, but reads from the predefined formatted input
    channel <a href="Scanf.Scanning.html#VALstdin"><code class="code"><span class="constructor">Scanf</span>.<span class="constructor">Scanning</span>.stdin</code></a> that is connected to <a href="Pervasives.html#VALstdin"><code class="code">stdin</code></a>.
</div>
</td></tr>
...
<td><div class="info">
<code class="code"><span class="constructor">Array0</span>.set&nbsp;a&nbsp;x&nbsp;v</code> stores the value <code class="code">v</code> in <code class="code">a</code>.
</div>
</td></tr>
...
<td><div class="info">
Same as <a href="Ephemeron.K1.html#VALset_data"><code class="code"><span class="constructor">Ephemeron</span>.<span class="constructor">K1</span>.set_data</code></a>
</div>
</td></tr>
...
<code class="code"><span class="constructor">Ephemeron</span>.<span class="constructor">K1</span>.set_data&nbsp;eph&nbsp;el</code> sets the data of <code class="code">eph</code> to be a
      (full) data to <code class="code">el</code>
</div>
</td></tr>
...
<td><div class="info">
Same as <a href="Ephemeron.K1.html#VALset_key"><code class="code"><span class="constructor">Ephemeron</span>.<span class="constructor">K1</span>.set_key</code></a>
</div>
</td></tr>
...
<code class="code"><span class="constructor">Ephemeron</span>.<span class="constructor">K1</span>.set_key&nbsp;eph&nbsp;el</code> sets the key of <code class="code">eph</code> to be a
      (full) key to <code class="code">el</code>
</div>
</td></tr>
...
<td><div class="info">
<code class="code"><span class="constructor">Targetint</span>.shift_left&nbsp;x&nbsp;y</code> shifts <code class="code">x</code> to the left by <code class="code">y</code> bits.
</div>
</td></tr>
...
<td><div class="info">
<code class="code"><span class="constructor">Targetint</span>.shift_right&nbsp;x&nbsp;y</code> shifts <code class="code">x</code> to the right by <code class="code">y</code> bits.
</div>
</td></tr>
...
<td><div class="info">
<code class="code"><span class="constructor">Targetint</span>.shift_right_logical&nbsp;x&nbsp;y</code> shifts <code class="code">x</code> to the right
...
<code class="code">size_in_bytes&nbsp;a</code> is the number of elements in <code class="code">a</code>
    multiplied by <code class="code">a</code>'s <a href="Bigarray.html#VALkind_size_in_bytes"><code class="code"><span class="constructor">Bigarray</span>.kind_size_in_bytes</code></a>.
</div>
</td></tr>
...
<td><div class="info">
<code class="code">size_in_bytes&nbsp;a</code> is <code class="code">a</code>'s <a href="Bigarray.html#VALkind_size_in_bytes"><code class="code"><span class="constructor">Bigarray</span>.kind_size_in_bytes</code></a>.
</div>
</td></tr>
...
<code class="code">size_in_bytes&nbsp;a</code> is the number of elements in <code class="code">a</code> multiplied
    by <code class="code">a</code>'s <a href="Bigarray.html#VALkind_size_in_bytes"><code class="code"><span class="constructor">Bigarray</span>.kind_size_in_bytes</code></a>.
</div>
</td></tr>
...
<code class="code">spellcheck&nbsp;env&nbsp;name</code> takes a list of names <code class="code">env</code> that exist in
    ...
    <code class="code">name</code> that it may be a typo for one of them.
</div>
</td></tr>
...
<td><div class="info">
same as <a href="Hashtbl.SeededS.html#VALstats"><code class="code"><span class="constructor">Hashtbl</span>.<span class="constructor">SeededS</span>.stats</code></a> but only count the alive bindings
</div>
</td></tr>
...
<td><div class="info">
A deprecated alias for <a href="Scanf.Scanning.html#VALstdin"><code class="code"><span class="constructor">Scanf</span>.<span class="constructor">Scanning</span>.stdin</code></a>, the scanning buffer reading from
    <a href="Pervasives.html#VALstdin"><code class="code">stdin</code></a>.
</div>
</td></tr>
...
<td><div class="info">
The standard input notion for the <a href="Scanf.html"><code class="code"><span class="constructor">Scanf</span></code></a> module.
</div>
</td></tr>
...
<code class="code">take&nbsp;series</code> takes a snapshot of the profiling annotations on the values
      ...
      result to the <code class="code">series</code> file.
</div>
</td></tr>
...
<code class="code">take&nbsp;q</code> removes and returns the first element in queue <code class="code">q</code>,
   or raises <a href="Queue.html#EXCEPTIONEmpty"><code class="code"><span class="constructor">Queue</span>.<span class="constructor">Empty</span></code></a> if the queue is empty.
</div>
</td></tr>
...
<tr><td><a href="Timings.html#VALtime">time</a> [<a href="Timings.html">Timings</a>]</td>
<td><div class="info">
<code class="code">time&nbsp;pass&nbsp;f&nbsp;arg</code> records the runtime of <code class="code">f&nbsp;arg</code>
</div>
</td></tr>
...
<tr><td><a href="Timings.html#VALtime_call">time_call</a> [<a href="Timings.html">Timings</a>]</td>
<td><div class="info">
<code class="code">time_call&nbsp;pass&nbsp;f</code> calls <code class="code">f</code> and records its runtime.
</div>
</td></tr>
...
<td><div class="info">
<code class="code">to_char&nbsp;u</code> is <code class="code">u</code> as an OCaml latin1 character.
</div>
</td></tr>
...
<td><div class="info">
<code class="code">to_int&nbsp;u</code> is <code class="code">u</code> as an integer.
</div>
</td></tr>
<tr><td><a href="Targetint.html#VALto_int">to_int</a> [<a href="Targetint.html">Targetint</a>]</td>
<td><div class="info">
Convert the given target integer (type <code class="code">t</code>) to an
...
<td><div class="info">
Convert the given target integer to a
    64-bit integer (type <code class="code">int64</code>).
</div>
</td></tr>
<tr><td><a href="Identifiable.S.Tbl.html#VALto_list">to_list</a> [<a href="Identifiable.S.Tbl.html">Identifiable.S.Tbl</a>]</td>
<td></td></tr>
...
<tr><td><a href="Identifiable.S.Tbl.html#VALto_map">to_map</a> [<a href="Identifiable.S.Tbl.html">Identifiable.S.Tbl</a>]</td>
<td></td></tr>
...
<tr><td><a href="Identifiable.S.Set.html#VALto_string">to_string</a> [<a href="Identifiable.S.Set.html">Identifiable.S.Set</a>]</td>
<td></td></tr>
...
Can be used within a ppx preprocessor to know which tool is
    ...
    <code class="code"><span class="string">"ocaml"</span></code>, ...
</div>
</td></tr>
...
<td></td></tr>
<tr><td><a href="Identifiable.S.Map.html#VALtranspose_keys_and_data">transpose_keys_and_data</a> [<a href="Identifiable.S.Map.html">Identifiable.S.Map</a>]</td>
<td></td></tr>
<tr><td><a href="Identifiable.S.Map.html#VALtranspose_keys_and_data_set">transpose_keys_and_data_set</a> [<a href="Identifiable.S.Map.html">Identifiable.S.Map</a>]</td>
<td></td></tr>
...
<td><div class="info">
See <a href="Unix.html#VALtruncate"><code class="code"><span class="constructor">Unix</span>.truncate</code></a>.
</div>
</td></tr>
...
<td><div class="info">
<code class="code">truncate&nbsp;b&nbsp;len</code> truncates the length of <code class="code">b</code> to <code class="code">len</code>
...
<td><div class="info">
<span class="deprecated">Return a copy of the argument, with the first character set to lowercase,
   using the ISO Latin-1 (8859-1) character set..
</span></div>
</td></tr>
...
<code class="code">union&nbsp;f&nbsp;m1&nbsp;m2</code> computes a map whose keys is the union of keys
        of <code class="code">m1</code> and of <code class="code">m2</code>.
</div>
</td></tr>
...
<tr><td><a href="Identifiable.S.Map.html#VALunion_left">union_left</a> [<a href="Identifiable.S.Map.html">Identifiable.S.Map</a>]</td>
<td><div class="info">
<code class="code">union_left&nbsp;m1&nbsp;m2&nbsp;=&nbsp;union_right&nbsp;m2&nbsp;m1</code>
</div>
</td></tr>
<tr><td><a href="Identifiable.S.Map.html#VALunion_merge">union_merge</a> [<a href="Identifiable.S.Map.html">Identifiable.S.Map</a>]</td>
<td></td></tr>
<tr><td><a href="Identifiable.S.Map.html#VALunion_right">union_right</a> [<a href="Identifiable.S.Map.html">Identifiable.S.Map</a>]</td>
<td><div class="info">
<code class="code">union_right&nbsp;m1&nbsp;m2</code> contains all bindings from <code class="code">m1</code> and <code class="code">m2</code>.
</div>
</td></tr>
...
<td><div class="info">
Same as <a href="Ephemeron.K1.html#VALunset_data"><code class="code"><span class="constructor">Ephemeron</span>.<span class="constructor">K1</span>.unset_data</code></a>
</div>
</td></tr>
...
<td><div class="info">
<code class="code"><span class="constructor">Ephemeron</span>.<span class="constructor">K1</span>.unset_data&nbsp;eph&nbsp;el</code> sets the key of <code class="code">eph</code> to be an
      empty key.
</div>
</td></tr>
<tr><td><a href="Obj.Ephemeron.html#VALunset_key">unset_key</a> [<a href="Obj.Ephemeron.html">Obj.Ephemeron</a>]</td>
<td><div class="info">
Same as <a href="Ephemeron.K1.html#VALunset_key"><code class="code"><span class="constructor">Ephemeron</span>.<span class="constructor">K1</span>.unset_key</code></a>
</div>
</td></tr>
...
<td><div class="info">
<span class="deprecated">Return a copy of the argument, with all lowercase letters
...
<td><div class="info">
<span class="deprecated">Convert the given character to its equivalent uppercase character,
   using the ISO Latin-1 (8859-1) character set.
</span></div>
</td></tr>
...
<td></td></tr>
<tr><td><a href="Builtin_attributes.html#VALwarning_enter_scope">warning_enter_scope</a> [<a href="Builtin_attributes.html">Builtin_attributes</a>]</td>
<td></td></tr>
<tr><td><a href="Builtin_attributes.html#VALwarning_leave_scope">warning_leave_scope</a> [<a href="Builtin_attributes.html">Builtin_attributes</a>]</td>
<td></td></tr>
...
<td></td></tr>
<tr><td><a href="Builtin_attributes.html#VALwith_warning_attribute">with_warning_attribute</a> [<a href="Builtin_attributes.html">Builtin_attributes</a>]</td>
<td></td></tr>
...
<td><div class="info">
<code class="code"><span class="constructor">Arg</span>.write_arg&nbsp;file&nbsp;args</code> writes the arguments <code class="code">args</code> newline-terminated
    into the file <code class="code">file</code>.
</div>
</td></tr>
<tr><td><a href="Arg.html#VALwrite_arg0">write_arg0</a> [<a href="Arg.html">Arg</a>]</td>
<td><div class="info">
Identical to <a href="Arg.html#VALwrite_arg"><code class="code"><span class="constructor">Arg</span>.write_arg</code></a> but uses the null character for terminator
    instead of newline.
</div>
</td></tr>
...
<td><div class="info">
<code class="code">zero_to_n&nbsp;n</code> is the set of numbers {0, ..., n} (inclusive).
</div>
</td></tr>
</tbody></table>
