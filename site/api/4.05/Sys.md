...
Return the value associated to a variable in the process
    environment or <code class="code"><span class="constructor">None</span></code> if the variable is unbound.<br>
<b>Since</b> 4.05<br>
</div>
...
Currently, the official distribution only supports <code class="code"><span class="constructor">Native</span></code> and
    ...
    compilers, for example, javascript.<br>
<b>Since</b> 4.04.0<br>
</div>
...
Backend type  currently executing the OCaml program.<br>
<b>Since</b> 4.04.0<br>
</div>
...
<p>
    ...
    At runtime, <code class="code">opaque_identity</code> disappears altogether.
</p><p>
