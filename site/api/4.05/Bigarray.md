...
</p><pre class="codepre"><code class="code">  <span class="keyword">let</span> zero : <span class="keyword">type</span> a b. (a, b) kind <span class="keywordsign">-&gt;</span> a = <span class="keyword">function</span>
...
<code class="code">kind_size_in_bytes&nbsp;k</code> is the number of bytes used to store
   an element of type <code class="code">k</code>.<br>
<b>Since</b> 4.03.0<br>
</div>
<br>
...
<h6 id="6_Zerodimensionalarrays">Zero-dimensional arrays</h6><br>

<pre><span class="keyword">module</span> <a href="Bigarray.Array0.html">Array0</a>: <code class="code"><span class="keyword">sig</span></code> <a href="Bigarray.Array0.html">..</a> <code class="code"><span class="keyword">end</span></code></pre><div class="info">
...
Return the zero-dimensional big array corresponding to the given
   ...
   does not have exactly zero dimension.<br>
<b>Since</b> 4.05.0<br>
</div>
