...
Return the size of the graphics window. Coordinates of the screen
   ...
   below <code class="code">-32768</code> or above <code class="code">32676</code>.<br>
</div>
<br>
...
Wait until one of the events specified in the given event list
   ...
   event is specified and the <code class="code"><span class="constructor">Poll</span></code> event is not specified.<br>
</div>
