...
<pre><span class="keyword">module</span> UnixLabels: <code class="code"><span class="keyword">sig</span></code> <a href="UnixLabels.html">..</a> <code class="code"><span class="keyword">end</span></code></pre><div class="info module top">
...
Set the close-on-exec flag on the
                                   descriptor returned by <a href="UnixLabels.html#VALopenfile"><code class="code"><span class="constructor">UnixLabels</span>.openfile</code></a><br>
</div>
</td><td class="typefieldcomment" align="left" valign="bottom"><code>*)</code></td>
</tr>
<tr>
...
<code class="code">symlink&nbsp;source&nbsp;dest</code> creates the file <code class="code">dest</code> as a symbolic link
   to the file <code class="code">source</code>. See <a href="Unix.html#VALsymlink"><code class="code"><span class="constructor">Unix</span>.symlink</code></a> for details of <code class="code">~to_dir</code><br>
</div>
...
<td class="typefieldcomment" align="left" valign="top"><code>(*</code></td><td class="typefieldcomment" align="left" valign="top"><div class="info ">
decrements in process virtual time, and sends <code class="code"><span class="constructor">SIGVTALRM</span></code> when
          expired.<br>
</div>
</td><td class="typefieldcomment" align="left" valign="bottom"><code>*)</code></td>
</tr>
...
<td class="typefieldcomment" align="left" valign="top"><code>(*</code></td><td class="typefieldcomment" align="left" valign="top"><div class="info ">
The flags for <a href="UnixLabels.html#VALrecv"><code class="code"><span class="constructor">UnixLabels</span>.recv</code></a>,  <a href="UnixLabels.html#VALrecvfrom"><code class="code"><span class="constructor">UnixLabels</span>.recvfrom</code></a>,
   <a href="UnixLabels.html#VALsend"><code class="code"><span class="constructor">UnixLabels</span>.send</code></a> and <a href="UnixLabels.html#VALsendto"><code class="code"><span class="constructor">UnixLabels</span>.sendto</code></a>.<br>
</div>
</td><td class="typefieldcomment" align="left" valign="bottom"><code>*)</code></td>
</tr></tbody></table>
...
Same as <a href="Unix.html#VALgetsockopt"><code class="code"><span class="constructor">Unix</span>.getsockopt</code></a> for a socket option whose value is
    an <code class="code">int&nbsp;option</code>.<br>
</div>
