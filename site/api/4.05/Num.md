...
<pre><span id="VALnum_of_string_opt"><span class="keyword">val</span> num_of_string_opt</span> : <code class="type">string -&gt; <a href="Num.html#TYPEnum">num</a> option</code></pre><div class="info ">
Convert a string to a number.
    Return <code class="code"><span class="constructor">None</span></code> if the given string is not
    a valid representation of an integer.<br>
<b>Since</b> 4.05<br>
</div>
<br>
...
<pre><span id="VALint_of_num_opt"><span class="keyword">val</span> int_of_num_opt</span> : <code class="type"><a href="Num.html#TYPEnum">num</a> -&gt; int option</code></pre><div class="info ">
<b>Since</b> 4.05.0<br>
</div>
...
<pre><span id="VALnat_of_num_opt"><span class="keyword">val</span> nat_of_num_opt</span> : <code class="type"><a href="Num.html#TYPEnum">num</a> -&gt; Nat.nat option</code></pre><div class="info ">
<b>Since</b> 4.05.0<br>
</div>
...
<pre><span id="VALbig_int_of_num_opt"><span class="keyword">val</span> big_int_of_num_opt</span> : <code class="type"><a href="Num.html#TYPEnum">num</a> -&gt; <a href="Big_int.html#TYPEbig_int">Big_int.big_int</a> option</code></pre><div class="info ">
<b>Since</b> 4.05.0<br>
</div>
