...
<p>
   ...
   Regarding the atomicity guarantees given by <code class="code">~cloexec:<span class="keyword">true</span></code> or by
...
<code class="code">symlink&nbsp;?to_dir&nbsp;source&nbsp;dest</code> creates the file <code class="code">dest</code> as a symbolic link
   ...
   be specified in new code). On Unix, <code class="code">~to_dir</code> is ignored.
<p>
...
<p>
   ...
   operation will block or fail.<br>
</p></div>
<br>
...
Convert a time in seconds, as returned by <a href="Unix.html#VALtime"><code class="code"><span class="constructor">Unix</span>.time</code></a>, into a date and
   ...
   to "UTC", use <a href="Unix.html#VALmktime"><code class="code"><span class="constructor">Unix</span>.mktime</code></a>, and then restore the original value of TZ.<br>
</div>
...
Convert a time in seconds, as returned by <a href="Unix.html#VALtime"><code class="code"><span class="constructor">Unix</span>.time</code></a>, into a date and
   ...
   The function performing the inverse conversion is <a href="Unix.html#VALmktime"><code class="code"><span class="constructor">Unix</span>.mktime</code></a>.<br>
</div>
