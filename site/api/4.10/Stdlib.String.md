...
<div id="search_results"></div><div class="toc_title"><a href="#top">Stdlib.String</a></div><ul><li><a href="#1_Iterators">Iterators</a></li></ul></nav></header>

<h1>Module <a href="type_Stdlib.String.html">Stdlib.String</a></h1>

<pre><span id="MODULEString"><span class="keyword">module</span> String</span>: <code class="type"><a href="String.html">String</a></code></pre><hr width="100%">
