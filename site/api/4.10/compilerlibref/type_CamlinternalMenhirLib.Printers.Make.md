...
<code class="code"><span class="keyword">functor</span>&nbsp;(<span class="constructor">I</span>&nbsp;:&nbsp;<span class="constructor">IncrementalEngine</span>.<span class="constructor">EVERYTHING</span>)<br>
