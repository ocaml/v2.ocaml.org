...
<p>This module is intended to be used through <a href="StdLabels.html"><code class="code"><span class="constructor">StdLabels</span></code></a> which replaces
...
<pre class="codepre"><code class="code">      <span class="keyword">open</span> <span class="constructor">StdLabels</span>
      ...
      <span class="keyword">let</span> seq len = <span class="constructor">List</span>.init ~f:(<span class="keyword">function</span> i <span class="keywordsign">-&gt;</span> i) ~len
   </code></pre>
...
<pre><span id="VALconcat_map"><span class="keyword">val</span> concat_map</span> : <code class="type">f:('a -&gt; 'b list) -&gt; 'a list -&gt; 'b list</code></pre><div class="info ">
<div class="info-desc">
...
<pre><span id="VALfind_map"><span class="keyword">val</span> find_map</span> : <code class="type">f:('a -&gt; 'b option) -&gt; 'a list -&gt; 'b option</code></pre><div class="info ">
<div class="info-desc">
