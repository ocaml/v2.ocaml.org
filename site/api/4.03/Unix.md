...
<p>
    ...
    <code class="code">handle_unix_error</code>) are liable to raise the <code class="code"><span class="constructor">Unix_error</span></code>
...
Return the value associated to a variable in the process
   environment.<br>
<b>Raises</b> <code>Not_found</code> if the variable is unbound.
<p>
...
<p>
   ...
   On Windows: not implemented, use <a href="Unix.html#VALcreate_process"><code class="code"><span class="constructor">Unix</span>.create_process</code></a> or threads.<br>
</p></div>
...
Set the close-on-exec flag on the
                                   descriptor returned by <a href="Unix.html#VALopenfile"><code class="code"><span class="constructor">Unix</span>.openfile</code></a><br>
</div>
</td><td class="typefieldcomment" align="left" valign="bottom"><code>*)</code></td>
</tr></tbody></table>
...
<pre><span class="keyword">module</span> <a href="Unix.LargeFile.html">LargeFile</a>: <code class="code"><span class="keyword">sig</span></code> <a href="Unix.LargeFile.html">..</a> <code class="code"><span class="keyword">end</span></code></pre><div class="info">
...
<pre><span id="VALdup"><span class="keyword">val</span> dup</span> : <code class="type"><a href="Unix.html#TYPEfile_descr">file_descr</a> -&gt; <a href="Unix.html#TYPEfile_descr">file_descr</a></code></pre><div class="info ">
Return a new file descriptor referencing the same file as
   the given descriptor.<br>
</div>

<pre><span id="VALdup2"><span class="keyword">val</span> dup2</span> : <code class="type"><a href="Unix.html#TYPEfile_descr">file_descr</a> -&gt; <a href="Unix.html#TYPEfile_descr">file_descr</a> -&gt; unit</code></pre><div class="info ">
...
<pre><span id="VALpipe"><span class="keyword">val</span> pipe</span> : <code class="type">unit -&gt; <a href="Unix.html#TYPEfile_descr">file_descr</a> * <a href="Unix.html#TYPEfile_descr">file_descr</a></code></pre><div class="info ">
...
High-level pipe and process management. This function
   ...
   (or <code class="code">cmd.exe</code> on Windows), cf. <code class="code">system</code>.<br>
</div>
...
<pre><span id="VALclose_process_in"><span class="keyword">val</span> close_process_in</span> : <code class="type"><a href="Pervasives.html#TYPEin_channel">in_channel</a> -&gt; <a href="Unix.html#TYPEprocess_status">process_status</a></code></pre><div class="info ">
...
<pre><span id="VALclose_process_out"><span class="keyword">val</span> close_process_out</span> : <code class="type"><a href="Pervasives.html#TYPEout_channel">out_channel</a> -&gt; <a href="Unix.html#TYPEprocess_status">process_status</a></code></pre><div class="info ">
...
<pre><span id="VALclose_process"><span class="keyword">val</span> close_process</span> : <code class="type"><a href="Pervasives.html#TYPEin_channel">in_channel</a> * <a href="Pervasives.html#TYPEout_channel">out_channel</a> -&gt; <a href="Unix.html#TYPEprocess_status">process_status</a></code></pre><div class="info ">
...
<code class="code">symlink ?to_dir source dest</code> creates the file <code class="code">dest</code> as a symbolic link
   ...
   be specified in new code). On Unix, <code class="code">~to_dir</code> ignored.
<p>
   ...
   <a href="Unix.html#VALhas_symlink"><code class="code"><span class="constructor">Unix</span>.has_symlink</code></a> can be used to check that a process is able to create symbolic
   links.<br>
</p></div>
...
Returns <code class="code"><span class="keyword">true</span></code> if the user is able to create symbolic links. On Windows,
   ...
   simply indicates that the symlink system call is available.<br>
</div>
...
<div class="info ">
Commands for <a href="Unix.html#VALlockf"><code class="code"><span class="constructor">Unix</span>.lockf</code></a>.<br>
</div>
...
<code class="code">kill pid <span class="keyword">sig</span></code> sends signal number <code class="code"><span class="keyword">sig</span></code> to the process
   with id <code class="code">pid</code>.  On Windows, only the <code class="code"><span class="constructor">Sys</span>.sigkill</code> signal
   is emulated.<br>
</div>
...
<code class="code">sigprocmask cmd sigs</code> changes the set of blocked signals.
   ...
   <code class="code">sigprocmask</code> returns the set of previously blocked signals.
<p>

   On Windows: not implemented (no inter-process signals on Windows).<br>
</p></div>
...
Same as <a href="Unix.html#VALtime"><code class="code"><span class="constructor">Unix</span>.time</code></a>, but with resolution better than 1 second.<br>
</div>
...
Stop execution for the given number of seconds.  Like <code class="code">sleep</code>,
    but fractions of seconds are supported.<br>
</div>
...
Set the last access time (second arg) and last modification time
   ...
   and last modification times are both set to the current time.<br>
</div>
...
<td class="typefieldcomment" align="left" valign="top"><code>(*</code></td><td class="typefieldcomment" align="left" valign="top"><div class="info ">
decrements in real time, and sends the signal <code class="code"><span class="constructor">SIGALRM</span></code> when
         expired.<br>
</div>
</td><td class="typefieldcomment" align="left" valign="bottom"><code>*)</code></td>
</tr>
...
<td class="typefieldcomment" align="left" valign="top"><code>(*</code></td><td class="typefieldcomment" align="left" valign="top"><div class="info ">
decrements in process virtual time, and sends <code class="code"><span class="constructor">SIGVTALRM</span></code>
          when expired.<br>
</div>
</td><td class="typefieldcomment" align="left" valign="bottom"><code>*)</code></td>
</tr>
...
(for profiling) decrements both when the process
         ...
         process; it sends <code class="code"><span class="constructor">SIGPROF</span></code> when expired.<br>
</div>
</td><td class="typefieldcomment" align="left" valign="bottom"><code>*)</code></td>
</tr></tbody></table>
...
Return the user id of the user executing the process.
   On Windows, always return <code class="code">1</code>.<br>
</div>
...
Find an entry in <code class="code">passwd</code> with the given name.<br>
<b>Raises</b> <code>Not_found</code> if no such entry exist.
<p>

   On Windows, always raise <code class="code"><span class="constructor">Not_found</span></code>.<br>
</p></div>
...
Find an entry in <code class="code">group</code> with the given name.<br>
<b>Raises</b> <code>Not_found</code> if no such entry exist.
<p>
...
Find an entry in <code class="code">passwd</code> with the given user id.<br>
<b>Raises</b> <code>Not_found</code> if no such entry exist.
<p>
...
Find an entry in <code class="code">group</code> with the given group id.<br>
<b>Raises</b> <code>Not_found</code> if no such entry exist.
<p>
...
Conversion from the printable representation of an Internet
    ...
    for IPv6 addresses.<br>
<b>Raises</b> <code>Failure</code> when given a string that does not match these formats.<br>
</div>
...
The type of socket domains.  Not all platforms support
    IPv6 sockets (type <code class="code"><span class="constructor">PF_INET6</span></code>).
    On Windows, the domains <code class="code"><span class="constructor">PF_UNIX</span></code> and <code class="code"><span class="constructor">PF_INET6</span></code> are not
    supported; <code class="code"><span class="constructor">PF_INET</span></code> is fully supported.<br>
</div>
...
<td class="typefieldcomment" align="left" valign="top"><code>(*</code></td><td class="typefieldcomment" align="left" valign="top"><div class="info ">
The type of socket addresses. <code class="code"><span class="constructor">ADDR_UNIX</span> name</code> is a socket
...
<pre><span id="VALsocket"><span class="keyword">val</span> socket</span> : <code class="type"><a href="Unix.html#TYPEsocket_domain">socket_domain</a> -&gt; <a href="Unix.html#TYPEsocket_type">socket_type</a> -&gt; int -&gt; <a href="Unix.html#TYPEfile_descr">file_descr</a></code></pre><div class="info ">
...
<pre><span id="VALsocketpair"><span class="keyword">val</span> socketpair</span> : <code class="type"><a href="Unix.html#TYPEsocket_domain">socket_domain</a> -&gt;<br>       <a href="Unix.html#TYPEsocket_type">socket_type</a> -&gt; int -&gt; <a href="Unix.html#TYPEfile_descr">file_descr</a> * <a href="Unix.html#TYPEfile_descr">file_descr</a></code></pre><div class="info ">
Create a pair of unnamed sockets, connected together.<br>
</div>

<pre><span id="VALaccept"><span class="keyword">val</span> accept</span> : <code class="type"><a href="Unix.html#TYPEfile_descr">file_descr</a> -&gt; <a href="Unix.html#TYPEfile_descr">file_descr</a> * <a href="Unix.html#TYPEsockaddr">sockaddr</a></code></pre><div class="info ">
...
<td class="typefieldcomment" align="left" valign="top"><code>(*</code></td><td class="typefieldcomment" align="left" valign="top"><div class="info ">
The flags for <a href="Unix.html#VALrecv"><code class="code"><span class="constructor">Unix</span>.recv</code></a>,  <a href="Unix.html#VALrecvfrom"><code class="code"><span class="constructor">Unix</span>.recvfrom</code></a>,
   <a href="Unix.html#VALsend"><code class="code"><span class="constructor">Unix</span>.send</code></a> and <a href="Unix.html#VALsendto"><code class="code"><span class="constructor">Unix</span>.sendto</code></a>.<br>
</div>
</td><td class="typefieldcomment" align="left" valign="bottom"><code>*)</code></td>
</tr></tbody></table>
...
<td class="typefieldcomment" align="left" valign="top"><code>(*</code></td><td class="typefieldcomment" align="left" valign="top"><div class="info ">
Deprecated.  Use <a href="Unix.html#VALgetsockopt_error"><code class="code"><span class="constructor">Unix</span>.getsockopt_error</code></a> instead.<br>
</div>
</td><td class="typefieldcomment" align="left" valign="bottom"><code>*)</code></td>
</tr>
<tr>
...
<pre><span id="VALopen_connection"><span class="keyword">val</span> open_connection</span> : <code class="type"><a href="Unix.html#TYPEsockaddr">sockaddr</a> -&gt; <a href="Pervasives.html#TYPEin_channel">in_channel</a> * <a href="Pervasives.html#TYPEout_channel">out_channel</a></code></pre><div class="info ">
...
``Shut down'' a connection established with <a href="Unix.html#VALopen_connection"><code class="code"><span class="constructor">Unix</span>.open_connection</code></a>;
   ...
   to free via <a href="Pervasives.html#VALclose_in"><code class="code">close_in</code></a>.<br>
</div>

<pre><span id="VALestablish_server"><span class="keyword">val</span> establish_server</span> : <code class="type">(<a href="Pervasives.html#TYPEin_channel">in_channel</a> -&gt; <a href="Pervasives.html#TYPEout_channel">out_channel</a> -&gt; unit) -&gt;<br>       <a href="Unix.html#TYPEsockaddr">sockaddr</a> -&gt; unit</code></pre><div class="info ">
...
<p>
   ...
   On Windows, it is not implemented.  Use threads.<br>
</p></div>
<br>
...
Find an entry in <code class="code">hosts</code> with the given name.<br>
<b>Raises</b> <code>Not_found</code> if no such entry exist.<br>
</div>
...
Find an entry in <code class="code">hosts</code> with the given address.<br>
<b>Raises</b> <code>Not_found</code> if no such entry exist.<br>
</div>
...
Find an entry in <code class="code">protocols</code> with the given name.<br>
<b>Raises</b> <code>Not_found</code> if no such entry exist.<br>
</div>
...
Find an entry in <code class="code">protocols</code> with the given protocol number.<br>
<b>Raises</b> <code>Not_found</code> if no such entry exist.<br>
</div>
...
Find an entry in <code class="code">services</code> with the given name.<br>
<b>Raises</b> <code>Not_found</code> if no such entry exist.<br>
</div>
...
Find an entry in <code class="code">services</code> with the given service number.<br>
<b>Raises</b> <code>Not_found</code> if no such entry exist.<br>
</div>
...
Set address to ``any'' address
                                            for use with <a href="Unix.html#VALbind"><code class="code"><span class="constructor">Unix</span>.bind</code></a><br>
</div>
</td><td class="typefieldcomment" align="left" valign="bottom"><code>*)</code></td>
</tr></tbody></table>
...
<code class="code">getnameinfo addr opts</code> returns the host name and service name
    ...
    empty list of options that governs how these names are obtained.<br>
<b>Raises</b> <code>Not_found</code> if an error occurs.<br>
</div>
<br>
