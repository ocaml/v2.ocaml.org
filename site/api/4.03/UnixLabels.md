...
<pre><span id="VALsendto_substring"><span class="keyword">val</span> sendto_substring</span> : <code class="type"><a href="UnixLabels.html#TYPEfile_descr">file_descr</a> -&gt;<br>       bug:string -&gt;<br>       pos:int -&gt;<br>       len:int -&gt; mode:<a href="UnixLabels.html#TYPEmsg_flag">msg_flag</a> list -&gt; <a href="UnixLabels.html#TYPEsockaddr">sockaddr</a> -&gt; int</code></pre><div class="info ">
