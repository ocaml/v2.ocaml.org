...
<div id="search_results"></div><div class="toc_title"><a href="#top">Stdlib.StringLabels</a></div><ul><li><a href="#1_Iterators">Iterators</a></li></ul></nav></header>

<h1>Module <a href="type_Stdlib.StringLabels.html">Stdlib.StringLabels</a></h1>

<pre><span id="MODULEStringLabels"><span class="keyword">module</span> StringLabels</span>: <code class="type"><a href="StringLabels.html">StringLabels</a></code></pre><hr width="100%">
