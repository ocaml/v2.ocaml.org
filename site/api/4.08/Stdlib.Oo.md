...
<div id="search_results"></div><div class="toc_title"><a href="#top">Stdlib.Oo</a></div><ul></ul></nav></header>

<h1>Module <a href="type_Stdlib.Oo.html">Stdlib.Oo</a></h1>

<pre><span id="MODULEOo"><span class="keyword">module</span> Oo</span>: <code class="type"><a href="Oo.html">Oo</a></code></pre><hr width="100%">
