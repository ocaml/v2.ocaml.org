...
<div id="search_results"></div><div class="toc_title"><a href="Identifiable.Pair.html">Identifiable.Pair</a></div><ul></ul></nav></header>
<code class="code"><span class="keyword">functor</span>&nbsp;(<span class="constructor">A</span>&nbsp;:&nbsp;<span class="constructor">Thing</span>)&nbsp;(<span class="constructor">B</span>&nbsp;:&nbsp;<span class="constructor">Thing</span>)&nbsp;<span class="keywordsign">-&gt;</span><br>
