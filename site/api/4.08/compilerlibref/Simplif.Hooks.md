...
<div id="search_results"></div><div class="toc_title"><a href="#top">Simplif.Hooks</a></div><ul></ul></nav></header>

<h1>Module <a href="type_Simplif.Hooks.html">Simplif.Hooks</a></h1>

<pre><span id="MODULEHooks"><span class="keyword">module</span> Hooks</span>: <code class="type"><a href="Misc.HookSig.html">Misc.HookSig</a></code><code class="type">  with type t = lambda</code></pre><hr width="100%">
