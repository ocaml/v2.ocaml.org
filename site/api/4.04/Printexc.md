...
<pre><span class="keyword">module</span> <a href="Printexc.Slot.html">Slot</a>: <code class="code"><span class="keyword">sig</span></code> <a href="Printexc.Slot.html">..</a> <code class="code"><span class="keyword">end</span></code></pre><br>
...
<code class="code">get_raw_backtrace_next_slot&nbsp;slot</code> returns the next slot inlined, if any.<br>
<b>Since</b> 4.04.0<br>
</div>
<br>
