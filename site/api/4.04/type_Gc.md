...
&nbsp;&nbsp;&nbsp;&nbsp;<span class="string">"caml_gc_minor_words_unboxed"</span>&nbsp;[@@noalloc]<br>
...
&nbsp;&nbsp;<span class="keyword">external</span>&nbsp;get_minor_free&nbsp;:&nbsp;unit&nbsp;<span class="keywordsign">-&gt;</span>&nbsp;int&nbsp;=&nbsp;<span class="string">"caml_get_minor_free"</span>&nbsp;[@@noalloc]<br>
