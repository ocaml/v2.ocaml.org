...
<p>
    ...
    In native code this function does not allocate.<br>
<b>Since</b> 4.04<br>
</p></div>
...
same as <a href="Gc.html#VALfinalise"><code class="code"><span class="constructor">Gc</span>.finalise</code></a> except the value is not given as argument. So
    ...
    called before the finalisation function attached with `GC.finalise_last`.<br>
<b>Since</b> 4.04<br>
</div>
