...
<div id="search_results"></div><div class="toc_title"><a href="#top">Stdlib.Set</a></div><ul></ul></nav></header>

<h1>Module <a href="type_Stdlib.Set.html">Stdlib.Set</a></h1>

<pre><span id="MODULESet"><span class="keyword">module</span> Set</span>: <code class="type"><a href="Set.html">Set</a></code></pre><hr width="100%">
