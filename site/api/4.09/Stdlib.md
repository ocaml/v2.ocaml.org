...
<p>Read an integer encoded in binary format (4 bytes, big-endian)
   from the given input channel. See <a href="Stdlib.html#VALoutput_binary_int"><code class="code">output_binary_int</code></a>.
...
<pre><span id="MODULEPervasives"><span class="keyword">module</span> <a href="Stdlib.Pervasives.html">Pervasives</a></span>: <code class="type"><a href="Pervasives.html">Pervasives</a></code></pre>
...
<pre><span id="MODULEWeak"><span class="keyword">module</span> <a href="Stdlib.Weak.html">Weak</a></span>: <code class="type"><a href="Weak.html">Weak</a></code></pre>
