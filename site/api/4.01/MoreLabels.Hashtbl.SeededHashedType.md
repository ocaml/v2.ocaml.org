...
<pre><span class="keyword">module type</span> SeededHashedType = <code class="type"><a href="Hashtbl.SeededHashedType.html">Hashtbl.SeededHashedType</a></code></pre><hr width="100%">
