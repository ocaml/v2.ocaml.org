...
<pre><span class="keyword">module</span> Callback: <code class="code"><span class="keyword">sig</span></code> <a href="Callback.html">..</a> <code class="code"><span class="keyword">end</span></code></pre>Registering OCaml values with the C runtime.
<p>
