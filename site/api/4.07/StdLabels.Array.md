...
<div id="search_results"></div><div class="toc_title"><a href="#top">StdLabels.Array</a></div><ul><li><a href="#1_Sorting">Sorting</a></li></ul></nav></header>

<h1>Module <a href="type_StdLabels.Array.html">StdLabels.Array</a></h1>

<pre><span id="MODULEArray"><span class="keyword">module</span> Array</span>: <code class="type"><a href="ArrayLabels.html">ArrayLabels</a></code></pre><hr width="100%">
