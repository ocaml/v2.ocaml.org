...
<div id="search_results"></div><div class="toc_title"><a href="#top">Identifiable.Set.T</a></div><ul></ul></nav></header>

<h1>Module <a href="type_Identifiable.Set.T.html">Identifiable.Set.T</a></h1>

<pre><span id="MODULET"><span class="keyword">module</span> T</span>: <code class="type"><a href="Set.OrderedType.html">Set.OrderedType</a></code><code class="type"> </code></pre><hr width="100%">
