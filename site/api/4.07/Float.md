...
<pre><span id="TYPEfpclass"><span class="keyword">type</span> <code class="type"></code>fpclass</span> = <code class="type"><a href="Pervasives.html#TYPEfpclass">fpclass</a></code> = </pre><table class="typetable">
<tbody><tr>
