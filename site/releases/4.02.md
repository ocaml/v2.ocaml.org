...
# OCaml 4.02.1
This page describes the most recent OCaml, version **4.02.1**,
released on 2014-10-14. Go [here](./) for a list of all releases.

A previous minor version 4.02.0 was released on 2014-08-29. Links
below point to 4.02.1 files. See
...
- [Source
  tarball](http://caml.inria.fr/pub/distrib/ocaml-4.02/ocaml-4.02.1.tar.gz)
  (.tar.gz) for compilation under Unix (including Linux and MacOS X)
  and Microsoft Windows (including Cygwin).

- Also available in
  [.tar.xz](http://caml.inria.fr/pub/distrib/ocaml-4.02/ocaml-4.02.1.tar.xz)
  format.
