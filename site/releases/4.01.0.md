...
The most recent version of OCaml is **4.01.0**. It was released on 2013-09-12.
...
was [4.00.1](4.00.1.html), released in 2012.
...
-   [GODI](http://godi.ocaml-programming.de/) and
    [OPAM](http://opam.ocamlpro.com/) are source-based distributions of
    OCaml and many companion libraries and tools. Compilation and
    installation are automated by powerful package managers.
-   You also have read-only [SVN access](http://caml.inria.fr/ocaml/anonsvn.en.html) to the working
