...
2020-02-21.  Go [here](./) for a list of all releases and
...
- [Source
  tarball](http://caml.inria.fr/pub/distrib/ocaml-4.10/ocaml-4.10.0.tar.gz)
  (.tar.gz) for compilation under Unix (including Linux and MacOS X)
  and Microsoft Windows (including Cygwin).
- Also available in
  [.tar.xz](http://caml.inria.fr/pub/distrib/ocaml-4.10/ocaml-4.10.0.tar.xz)
  format.
...
The
[INSTALL](http://caml.inria.fr/pub/distrib/ocaml-4.10/notes/INSTALL.adoc) file
of the distribution provides detailed compilation and installation
instructions — see also the [Windows release
notes](http://caml.inria.fr/pub/distrib/ocaml-4.10/notes/README.win32.adoc) for
...
- [browsed
  online](http://caml.inria.fr/pub/docs/manual-ocaml-4.10/index.html),
- downloaded as a single
  [PostScript](http://caml.inria.fr/pub/distrib/ocaml-4.10/ocaml-4.10-refman.ps.gz),
  [PDF](http://caml.inria.fr/pub/distrib/ocaml-4.10/ocaml-4.10-refman.pdf),
  or [plain
  text](http://caml.inria.fr/pub/distrib/ocaml-4.10/ocaml-4.10-refman.txt)
  document,
- downloaded as a single
  [TAR](http://caml.inria.fr/pub/distrib/ocaml-4.10/ocaml-4.10-refman-html.tar.gz)
  or
  [ZIP](http://caml.inria.fr/pub/distrib/ocaml-4.10/ocaml-4.10-refman-html.zip)
  archive of HTML files,
- downloaded as a single
  [tarball](http://caml.inria.fr/pub/distrib/ocaml-4.10/ocaml-4.10-refman.info.tar.gz)
  of Emacs info files,
...
directory](http://caml.inria.fr/pub/distrib/ocaml-4.10), along with
...
This is the
[changelog](http://caml.inria.fr/pub/distrib/ocaml-4.10/notes/Changes).
