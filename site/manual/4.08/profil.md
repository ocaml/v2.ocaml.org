...
<header><nav class="toc brand"><a class="brand" href="https://ocaml.org/"><img src="colour-logo-gray.svg" class="svg" alt="OCaml"></a></nav><nav class="toc"><div class="toc_version"><a href="/docs" id="version-select">Version 4.08</a></div><div class="toc_title"><a href="#">Profiling (ocamlprof)</a></div><ul><li class="top"><a href="#">Top</a></li>
<li><a href="#sec410">1&nbsp;&nbsp;Compiling for profiling</a>
</li><li><a href="#sec414">2&nbsp;&nbsp;Profiling an execution</a>
</li><li><a href="#sec415">3&nbsp;&nbsp;Printing profiling information</a>
</li><li><a href="#sec416">4&nbsp;&nbsp;Time profiling</a>
</li></ul></nav></header>
<p> <a id="c:profiler"></a>
...
may not be exact.</p>
<h5 class="paragraph" id="sec417">Note</h5>
