...
<header><nav class="toc brand"><a class="brand" href="https://ocaml.org/"><img src="colour-logo-gray.svg" class="svg" alt="OCaml"></a></nav><nav class="toc"><div class="toc_version"><a href="/docs" id="version-select">Version 4.05</a></div><div class="toc_title"><a href="#">Dependency generator (ocamldep)</a></div><ul><li class="top"><a href="#">Top</a></li>
<li><a href="depend.html#sec317">1&nbsp;&nbsp;Options</a>
</li><li><a href="depend.html#sec318">2&nbsp;&nbsp;A typical Makefile</a>
</li></ul></nav></header>
<p> <a id="c:camldep"></a>
...
Pipe abstract syntax trees through preprocessor <span class="c009">command</span>.</dd><dt class="dt-description"><span class="c006">-slash</span></dt><dd class="dd-description">
