...
<header><nav class="toc brand"><a class="brand" href="https://ocaml.org/"><img src="colour-logo-gray.svg" class="svg" alt="OCaml"></a></nav><nav class="toc"><div class="toc_version"><a href="/docs" id="version-select">Version 4.05</a></div><div class="toc_title"><a href="#">Native-code compilation (ocamlopt)</a></div><ul><li class="top"><a href="#">Top</a></li>
<li><a href="native.html#sec286">1&nbsp;&nbsp;Overview of the compiler</a>
</li><li><a href="native.html#sec287">2&nbsp;&nbsp;Options</a>
</li><li><a href="native.html#sec292">3&nbsp;&nbsp;Common errors</a>
</li><li><a href="native.html#sec293">4&nbsp;&nbsp;Running executables produced by ocamlopt</a>
</li><li><a href="native.html#sec294">5&nbsp;&nbsp;Compatibility with the bytecode compiler</a>
</li></ul></nav></header>
...
(chapter&nbsp;<a href="comp.html#c%3Acamlc">8</a>).</p></li><li class="li-itemize">Arguments ending in <span class="c003">.cmx</span> are taken to be compiled object code. These
...
summary of its configuration, then exit.</dd><dt class="dt-description"><span class="c013"><span class="c003">-for-pack</span> <span class="c009">module-path</span></span></dt><dd class="dd-description">
...
analysis program <span class="c003">gprof</span>. (See chapter&nbsp;<a href="profil.html#c%3Aprofiler">17</a> for more
...
<span class="c006">-march=v8</span></dt><dd class="dd-description"> Generate SPARC version 8 code.
</dd><dt class="dt-description"><span class="c006">-march=v9</span></dt><dd class="dd-description"> Generate SPARC version 9 code.
</dd></dl><p>
...
(see section&nbsp;<a href="runtime.html#ocamlrun-options">10.2</a>), except that option <span class="c003">l</span>
...
By raising a <span class="c003">Stack_overflow</span> exception, like the bytecode
