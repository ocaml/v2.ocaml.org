...
<li><a href="#sec62">1&nbsp;&nbsp;Lexical conventions</a>
</li><li><a href="#sec75">2&nbsp;&nbsp;Values</a>
</li><li><a href="#sec88">3&nbsp;&nbsp;Names</a>
</li><li><a href="#sec91">4&nbsp;&nbsp;Type expressions</a>
</li><li><a href="#sec102">5&nbsp;&nbsp;Constants</a>
</li><li><a href="#sec103">6&nbsp;&nbsp;Patterns</a>
</li><li><a href="#s:value-expr">7&nbsp;&nbsp;Expressions</a>
</li><li><a href="#sec154">8&nbsp;&nbsp;Type and exception definitions</a>
</li><li><a href="#sec157">9&nbsp;&nbsp;Classes</a>
</li><li><a href="#sec185">10&nbsp;&nbsp;Module types (module specifications)</a>
</li><li><a href="#s:module-expr">11&nbsp;&nbsp;Module expressions (module implementations)</a>
</li><li><a href="#sec214">12&nbsp;&nbsp;Compilation units</a>
</li></ul></nav></header>
...
<ul>
<li><a href="#sec76">2.1&nbsp;&nbsp;Base values</a>
</li><li><a href="#sec81">2.2&nbsp;&nbsp;Tuples</a>
</li><li><a href="#sec82">2.3&nbsp;&nbsp;Records</a>
</li><li><a href="#sec83">2.4&nbsp;&nbsp;Arrays</a>
</li><li><a href="#sec84">2.5&nbsp;&nbsp;Variant values</a>
</li><li><a href="#sec85">2.6&nbsp;&nbsp;Polymorphic variants</a>
</li><li><a href="#sec86">2.7&nbsp;&nbsp;Functions</a>
</li><li><a href="#sec87">2.8&nbsp;&nbsp;Objects</a>
</li></ul>
...
</li><li class="li-itemize">labels (<a class="syntax" href="lex.html#label-name"><span class="c010">label-name</span></a>, defined in section&nbsp;<a href="lex.html#s%3Alabelname">6.1</a>),
...
<a id="hevea_manual.kwd6"></a></p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
The capitalization rules are summarized in the table below.</p><div class="center"><table class="c000 cellpadding1" border="1"><tbody><tr><td class="c014"><span class="c013">Name space</span></td><td class="c014"><span class="c013">Case of first letter</span> </td></tr>
<tr><td class="c016">
...
</tbody></table></div><p><span class="c009">Note on polymorphic variant tags:</span> the current implementation accepts
...
<p>
<a id="hevea_manual.kwd7"></a></p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
</p><div class="center"><table class="c000 cellpadding1" border="1"><tbody><tr><td class="c014"><span class="c013">Operator</span></td><td class="c014"><span class="c013">Associativity</span> </td></tr>
<tr><td class="c016">
...
<a class="syntax" href="#typexpr"><span class="c010">typexpr</span></a>.</p><h4 class="subsubsection" id="sec94">Function types</h4>
...
<a class="syntax" href="#typexpr"><span class="c010">typexpr</span></a><sub>1</sub> <span class="c002"><span class="c003">option</span> <span class="c003">-&gt;</span></span> &nbsp;<a class="syntax" href="#typexpr"><span class="c010">typexpr</span></a><sub>2</sub>.</p><h4 class="subsubsection" id="sec95">Tuple types</h4>
...
… &nbsp;<a class="syntax" href="#typexpr"><span class="c010">typexpr</span></a><sub><span class="c009">n</span></sub> respectively.</p><h4 class="subsubsection" id="sec96">Constructed types</h4>
...
<a class="syntax" href="names.html#typeconstr"><span class="c010">typeconstr</span></a>.</p><h4 class="subsubsection" id="sec97">Aliased and recursive types</h4>
...
of <a class="syntax" href="#typexpr"><span class="c010">typexpr</span></a> is captured by <span class="c004">'</span> <a class="syntax" href="lex.html#ident"><span class="c010">ident</span></a>, and quantified upon.</p><h4 class="subsubsection" id="sec98">Polymorphic variant types</h4>
<p>
<a id="hevea_manual.kwd10"></a></p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
<span class="c002"><span class="c003">[&lt;</span> <span class="c010">t</span> <span class="c003">&gt;</span> <span class="c003">`</span></span><a class="syntax" href="names.html#tag-name"><span class="c010">tag</span></a><sub>1</sub> …<span class="c004">`</span>&nbsp;<a class="syntax" href="names.html#tag-name"><span class="c010">tag</span></a><sub><span class="c009">k</span></sub><span class="c004">]</span></p><h4 class="subsubsection" id="sec101">Variant and record types</h4>
...
<a id="hevea_manual.kwd14"></a></p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
&nbsp;</td></tr>
<tr><td class="c018">&nbsp;</td><td class="c015">∣</td><td class="c017">&nbsp;<span class="c004">{</span>&nbsp;<a class="syntax" href="names.html#field"><span class="c010">field</span></a>&nbsp;&nbsp;[<span class="c004">:</span>&nbsp;<a class="syntax" href="types.html#typexpr"><span class="c010">typexpr</span></a>]&nbsp;<span class="c004">=</span>&nbsp;&nbsp;<a class="syntax" href="#pattern"><span class="c010">pattern</span></a>&nbsp;{&nbsp;<span class="c004">;</span>&nbsp;<a class="syntax" href="names.html#field"><span class="c010">field</span></a>&nbsp;&nbsp;[<span class="c004">:</span>&nbsp;<a class="syntax" href="types.html#typexpr"><span class="c010">typexpr</span></a>]&nbsp;<span class="c004">=</span>&nbsp;&nbsp;<a class="syntax" href="#pattern"><span class="c010">pattern</span></a>&nbsp;}&nbsp;&nbsp;[&nbsp;<span class="c004">;</span>&nbsp;]&nbsp;<span class="c004">}</span>
&nbsp;</td></tr>
...
<tr><td class="c016"><span class="c003">lazy</span> (see section&nbsp;<a href="extn.html#s%3Alazypat">7.3</a>)</td><td class="c016">– </td></tr>
...
<span class="c004">when</span> guards can be used for this purpose).</p><h4 class="subsubsection" id="sec105">Constant patterns</h4>
...
bindings performed by the matching against <a class="syntax" href="#pattern"><span class="c010">pattern</span></a><sub>1</sub>.</p><h4 class="subsubsection" id="sec107">Parenthesized patterns</h4>
...
<a class="syntax" href="types.html#typexpr"><span class="c010">typexpr</span></a>.</p><h4 class="subsubsection" id="sec108">“Or” patterns</h4>
...
Otherwise, value&nbsp;<span class="c009">v</span> matches <a class="syntax" href="#pattern"><span class="c010">pattern</span></a><sub>2</sub> whose bindings are performed.</p><h4 class="subsubsection" id="sec109">Variant patterns</h4>
...
<a class="syntax" href="#pattern"><span class="c010">pattern</span></a><sub>1</sub> <span class="c004">::</span> … <span class="c004">::</span> &nbsp;<a class="syntax" href="#pattern"><span class="c010">pattern</span></a><sub><span class="c009">n</span></sub> <span class="c002"><span class="c003">::</span> <span class="c003">[]</span></span>.</p><h4 class="subsubsection" id="sec110">Polymorphic variant patterns</h4>
...
<a class="syntax" href="#pattern"><span class="c010">pattern</span></a><sub>1</sub>.</p><h4 class="subsubsection" id="sec111">Polymorphic variant abbreviation patterns</h4>
...
<a class="syntax" href="#pattern"><span class="c010">pattern</span></a><sub><span class="c009">i</span></sub> matches <span class="c009">v</span><sub><span class="c009">i</span></sub> for <span class="c009">i</span> = 1,… , <span class="c009">n</span>.</p><h4 class="subsubsection" id="sec113">Record patterns</h4>
...
by field with <span class="c004">{</span> <a class="syntax" href="names.html#field"><span class="c010">field</span></a><sub>1</sub> <span class="c004">:</span> &nbsp;<a class="syntax" href="types.html#typexpr"><span class="c010">typexpr</span></a><sub>1</sub> <span class="c004">=</span> &nbsp;<a class="syntax" href="#pattern"><span class="c010">pattern</span></a><sub>1</sub> <span class="c004">;</span>… <span class="c004">;</span>&nbsp;<a class="syntax" href="names.html#field"><span class="c010">field</span></a><sub><span class="c009">n</span></sub> <span class="c004">:</span> &nbsp;<a class="syntax" href="types.html#typexpr"><span class="c010">typexpr</span></a><sub><span class="c009">n</span></sub> <span class="c004">=</span> &nbsp;<a class="syntax" href="#pattern"><span class="c010">pattern</span></a><sub><span class="c009">n</span></sub> <span class="c004">}</span> to force the type
of <a class="syntax" href="names.html#field"><span class="c010">field</span></a><sub><span class="c009">k</span></sub> to be compatible with <a class="syntax" href="types.html#typexpr"><span class="c010">typexpr</span></a><sub><span class="c009">k</span></sub>.</p><h4 class="subsubsection" id="sec114">Array patterns</h4>
...
matches the pattern <a class="syntax" href="#pattern"><span class="c010">pattern</span></a><sub><span class="c009">i</span></sub>, for <span class="c009">i</span> = 1,… , <span class="c009">n</span>.</p><h4 class="subsubsection" id="sec115">Range patterns</h4>
<p>The pattern
...
<ul>
<li><a href="#sec117">7.1&nbsp;&nbsp;Basic expressions</a>
</li><li><a href="#sec125">7.2&nbsp;&nbsp;Control structures</a>
</li><li><a href="#sec132">7.3&nbsp;&nbsp;Operations on data structures</a>
</li><li><a href="#sec139">7.4&nbsp;&nbsp;Operators</a>
</li><li><a href="#sec140">7.5&nbsp;&nbsp;Objects</a>
</li><li><a href="#sec146">7.6&nbsp;&nbsp;Coercions</a>
</li><li><a href="#sec150">7.7&nbsp;&nbsp;Other</a>
</li></ul>
<p>
...
&nbsp;[&nbsp;<span class="c004">:</span>&nbsp;<a class="syntax" href="modtypes.html#module-type"><span class="c010">module-type</span></a>&nbsp;]&nbsp;&nbsp;<span class="c004">=</span>&nbsp;&nbsp;<a class="syntax" href="modules.html#module-expr"><span class="c010">module-expr</span></a>&nbsp;<span class="c004">in</span>&nbsp;&nbsp;<a class="syntax" href="#expr"><span class="c010">expr</span></a>&nbsp;</td></tr>
<tr><td class="c018">&nbsp;</td></tr>
</tbody></table></td></tr>
...
See also the following language extensions:
<a href="extn.html#s%3Alocal-opens">local opens</a>,
<a href="extn.html#s%3Arecord-and-object-notations">record and object notations</a>,
<a href="extn.html#s%3Aexplicit-polymorphic-type">explicit polymorphic type annotations</a>,
<a href="extn.html#s-first-class-modules">first-class modules</a>,
...
<a href="extn.html#s%3Aattributes">attributes</a>,
<a href="extn.html#s%3Aextension-nodes">extension nodes</a> and
<a href="extn.html#s%3Alocal-exceptions">local exceptions</a>.</p><p>The table below shows the relative precedences and associativity of
...
<tr><td class="c016"><span class="c003">.   .(   .[   .{</span> (see section&nbsp;<a href="extn.html#s%3Abigarray-access">7.17</a>)</td><td class="c016">– </td></tr>
<tr><td class="c016"><span class="c003">#</span>…</td><td class="c016">– </td></tr>
...
of the derivation can be checked in the <span class="c003">-principal</span> mode.</p><h4 class="subsubsection" id="sec122">Function definition</h4>
...
If the matching fails, the exception <span class="c003">Match_failure</span> is raised.</p><h4 class="subsubsection" id="sec123">Guards in pattern-matchings</h4>
...
is resumed against the patterns following <a class="syntax" href="patterns.html#pattern"><span class="c010">pattern</span></a><sub><span class="c009">i</span></sub>.</p><h4 class="subsubsection" id="sec124">Local definitions</h4>
...
<a class="syntax" href="#expr"><span class="c010">expr</span></a><sub>2</sub>, and returns the value of <a class="syntax" href="#expr"><span class="c010">expr</span></a><sub>2</sub>.</p><h4 class="subsubsection" id="sec127">Conditional</h4>
<p>
...
<span class="c002"><span class="c003">else</span> <span class="c003">()</span></span>.</p><h4 class="subsubsection" id="sec128">Case expression</h4>
...
(respectively) <span class="c004">&amp;&amp;</span> and <span class="c004">||</span>.</p><h4 class="subsubsection" id="sec130">Loops</h4>
...
value <span class="c004">()</span>.</p><h4 class="subsubsection" id="sec131">Exception handling</h4>
<p>
...
values of <a class="syntax" href="#expr"><span class="c010">expr</span></a><sub>1</sub> to <a class="syntax" href="#expr"><span class="c010">expr</span></a><sub><span class="c009">n</span></sub>.</p><h4 class="subsubsection" id="sec135">Polymorphic variants</h4>
...
value whose tag is <a class="syntax" href="names.html#tag-name"><span class="c010">tag-name</span></a>, and whose argument is the value of <a class="syntax" href="#expr"><span class="c010">expr</span></a>.</p><h4 class="subsubsection" id="sec136">Records</h4>
...
which are initialized to <a class="syntax" href="#expr"><span class="c010">expr</span></a><sub>1</sub> … &nbsp;<a class="syntax" href="#expr"><span class="c010">expr</span></a><sub><span class="c009">n</span></sub>. As previously, it is
...
<span class="c004">()</span>.</p><h4 class="subsubsection" id="sec137">Arrays</h4>
...
the access is out of bounds. The value of the whole expression is <span class="c004">()</span>.</p><h4 class="subsubsection" id="sec138">Strings</h4>
...
library module <span class="c003">Pervasives</span> in chapter&nbsp;<a href="core.html#c%3Acorelib">23</a> for more
...
interpreted respectively as the functions <span class="c004">(~-)</span> and <span class="c004">(~-.)</span>.</p><p><a id="hevea_manual.kwd75"></a><a id="hevea_manual.kwd76"></a><a id="hevea_manual.kwd77"></a><a id="hevea_manual.kwd78"></a><a id="hevea_manual.kwd79"></a><a id="hevea_manual.kwd80"></a><a id="hevea_manual.kwd81"></a></p><div class="center"><table class="c000 cellpadding1" border="1"><tbody><tr><td class="c014"><span class="c013">Operator</span></td><td class="c014"><span class="c013">Initial meaning</span> </td></tr>
<tr><td class="c022">
...
<a href="classes.html#ss%3Aclass-body">6.9.2</a> and following for the syntax of <a class="syntax" href="classes.html#class-body"><span class="c010">class-body</span></a>—
...
checked in the <span class="c003">-principal</span> mode.</p><h4 class="subsubsection" id="sec144">Accessing and modifying instance variables</h4>
...
<a class="syntax" href="names.html#inst-var-name"><span class="c010">inst-var-name</span></a> <span class="c004">&lt;-</span> &nbsp;<a class="syntax" href="#expr"><span class="c010">expr</span></a> evaluates to <span class="c004">()</span>.</p><h4 class="subsubsection" id="sec145">Object duplication</h4>
<p>An object can be duplicated using the library function <span class="c003">Oo.copy</span>
(see
<a href="../../api/4.05/Oo.html">Module <span class="c003">Oo</span></a>). Inside a method, the expression
...
which may be an extensible type, if every <a class="syntax" href="types.html#typexpr"><span class="c010">typ</span></a><sub><span class="c009">i</span></sub> is a subtype of <a class="syntax" href="types.html#typexpr"><span class="c010">typ</span></a>′<sub><span class="c009">i</span></sub>.</p><h4 class="subsubsection" id="sec149">Variance</h4>
...
of <span class="c003">Lazy.force</span> may be implicit through pattern matching (see&nbsp;<a href="extn.html#s%3Alazypat">7.3</a>).</p><h4 class="subsubsection" id="sec153">Local modules</h4>
<p>
...
<ul>
<li><a href="#sec155">8.1&nbsp;&nbsp;Type definitions</a>
</li><li><a href="#sec156">8.2&nbsp;&nbsp;Exception definitions</a>
</li></ul>
...
<a id="hevea_manual.kwd91"></a></p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
checking the validity of <span class="c004">:&gt;</span> coercions (see section <a href="expr.html#s%3Acoercions">6.7.6</a>).</p><p>For instance, <span class="c003">type +'a t</span> declares <span class="c003">t</span> as an abstract type that is
...
<p> <a id="s:excdef"></a>
<a id="hevea_manual.kwd96"></a></p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
<ul>
<li><a href="#sec158">9.1&nbsp;&nbsp;Class types</a>
</li><li><a href="#sec167">9.2&nbsp;&nbsp;Class expressions</a>
</li><li><a href="#sec180">9.3&nbsp;&nbsp;Class definitions</a>
</li><li><a href="#sec183">9.4&nbsp;&nbsp;Class specifications</a>
</li><li><a href="#sec184">9.5&nbsp;&nbsp;Class type definitions</a>
</li></ul>
<p>
...
<a id="hevea_manual.kwd105"></a></p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
See also the following language extensions:
<a href="extn.html#s%3Aattributes">attributes</a> and
<a href="extn.html#s%3Aextension-nodes">extension nodes</a>.</p><h4 class="subsubsection" id="sec159">Simple class expressions</h4>
...
…<a class="syntax" href="types.html#typexpr"><span class="c010">typexpr</span></a><sub><span class="c009">n</span></sub>.</p><h4 class="subsubsection" id="sec160">Class function type</h4>
...
type <a class="syntax" href="#class-type"><span class="c010">class-type</span></a>.</p><h4 class="subsubsection" id="sec161">Class body type</h4>
...
<p><a id="hevea_manual.kwd106"></a></p><p>The inheritance construct <span class="c004">inherit</span> <a class="syntax" href="#class-body-type"><span class="c010">class-body-type</span></a> provides for inclusion of
...
<a id="hevea_manual.kwd112"></a></p><p>A virtual method specification is written <span class="c004">method</span> [<span class="c004">private</span>]
...
name of the method and <a class="syntax" href="types.html#poly-typexpr"><span class="c010">poly-typexpr</span></a> its expected type.</p><h4 class="subsubsection" id="sec166">Constraints on type parameters</h4>
<p><a id="hevea_manual.kwd113"></a></p><p>The construct <span class="c004">constraint</span> <a class="syntax" href="types.html#typexpr"><span class="c010">typexpr</span></a><sub>1</sub> <span class="c004">=</span> &nbsp;<a class="syntax" href="types.html#typexpr"><span class="c010">typexpr</span></a><sub>2</sub> forces the two
...
<a id="hevea_manual.kwd126"></a></p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
<a href="extn.html#s%3Aexplicit-overriding">explicit overriding in class definitions</a>,
<a href="extn.html#s%3Aattributes">attributes</a> and
<a href="extn.html#s%3Aextension-nodes">extension nodes</a>.</p><h4 class="subsubsection" id="sec168">Simple class expressions</h4>
...
<a class="syntax" href="#class-type"><span class="c010">class-type</span></a> are hidden and can no longer be accessed.</p><h4 class="subsubsection" id="sec169">Class application</h4>
...
<p><a id="hevea_manual.kwd127"></a></p><p>The inheritance construct <span class="c004">inherit</span> <a class="syntax" href="#class-expr"><span class="c010">class-expr</span></a> allows reusing
...
<a id="hevea_manual.kwd130"></a></p><p>The definition <span class="c004">val</span> [<span class="c004">mutable</span>] <a class="syntax" href="names.html#inst-var-name"><span class="c010">inst-var-name</span></a> <span class="c004">=</span> &nbsp;<a class="syntax" href="expr.html#expr"><span class="c010">expr</span></a> adds an
...
<a id="hevea_manual.kwd132"></a></p><p>A variable specification is written <span class="c004">val</span> [<span class="c004">mutable</span>] <span class="c004">virtual</span>
...
<a id="hevea_manual.kwd134"></a></p><p>A method definition is written <span class="c004">method</span> <a class="syntax" href="names.html#method-name"><span class="c010">method-name</span></a> <span class="c004">=</span> &nbsp;<a class="syntax" href="expr.html#expr"><span class="c010">expr</span></a>. The
...
…, &nbsp;<a class="syntax" href="expr.html#expr"><span class="c010">expr</span></a><sub><span class="c009">n</span></sub>.</p><h4 class="subsubsection" id="sec177">Virtual method definition</h4>
<p><a id="hevea_manual.kwd135"></a>
<a id="hevea_manual.kwd136"></a></p><p>A method specification is written <span class="c004">method</span> [<span class="c004">private</span>] <span class="c004">virtual</span>
...
<p><a id="hevea_manual.kwd137"></a></p><p>The construct <span class="c004">constraint</span> <a class="syntax" href="types.html#typexpr"><span class="c010">typexpr</span></a><sub>1</sub> <span class="c004">=</span> &nbsp;<a class="syntax" href="types.html#typexpr"><span class="c010">typexpr</span></a><sub>2</sub> forces the two
...
<p><a id="hevea_manual.kwd138"></a></p><p>A class initializer <span class="c004">initializer</span> <a class="syntax" href="expr.html#expr"><span class="c010">expr</span></a> specifies an expression that
...
<a id="hevea_manual.kwd140"></a></p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
<a id="hevea_manual.kwd145"></a></p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
<ul>
<li><a href="#sec186">10.1&nbsp;&nbsp;Simple module types</a>
</li><li><a href="#sec187">10.2&nbsp;&nbsp;Signatures</a>
</li><li><a href="#sec197">10.3&nbsp;&nbsp;Functor types</a>
</li><li><a href="#sec198">10.4&nbsp;&nbsp;The <span class="c003">with</span> operator</a>
</li></ul>
...
<ul>
<li><a href="#sec200">11.1&nbsp;&nbsp;Simple module expressions</a>
</li><li><a href="#sec201">11.2&nbsp;&nbsp;Structures</a>
</li><li><a href="#sec211">11.3&nbsp;&nbsp;Functors</a>
</li></ul>
...
chapter&nbsp;<a href="comp.html#c%3Acamlc">8</a> for more details) and <a class="syntax" href="modtypes.html#specification"><span class="c010">specification</span></a><sub>1</sub> …
