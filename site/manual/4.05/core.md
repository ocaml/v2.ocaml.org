...
<h1 class="chapter" id="sec523"><span>Chapter 23</span>&nbsp;&nbsp;The core library</h1>
<header><nav class="toc brand"><a class="brand" href="https://ocaml.org/"><img src="colour-logo-gray.svg" class="svg" alt="OCaml"></a></nav><nav class="toc"><div class="toc_version"><a href="/docs" id="version-select">Version 4.05</a></div><div class="toc_title"><a href="#">The core library</a></div><ul><li class="top"><a href="#">Top</a></li>
<li><a href="#sec524">Conventions</a>
</li><li><a href="#sec525">1&nbsp;&nbsp;Built-in types and predefined exceptions</a>
</li><li><a href="#sec528">2&nbsp;&nbsp;Module <span class="c003">Pervasives</span>: the initially opened module</a>
</li></ul></nav></header>
...
<h2 class="section" id="sec525">1&nbsp;&nbsp;Built-in types and predefined exceptions</h2>
...
See the <span class="c003">Int32</span>[<a href="../../api/4.05/Int32.html"><span class="c003">Int32</span></a>] module.
</blockquote><pre>type int64
</pre><p><a id="hevea_manual21"></a>
</p><blockquote class="quote">
The type of signed 64-bit integers.
See the <span class="c003">Int64</span>[<a href="../../api/4.05/Int64.html"><span class="c003">Int64</span></a>] module.
...
See the <span class="c003">Nativeint</span>[<a href="../../api/4.05/Nativeint.html"><span class="c003">Nativeint</span></a>] module.
...
<span class="c003">%t</span> printing functions (see module <span class="c003">Printf</span>[<a href="../../api/4.05/Printf.html"><span class="c003">Printf</span></a>]),
...
(see module <span class="c003">Scanf</span>[<a href="../../api/4.05/Scanf.html"><span class="c003">Scanf</span></a>]),
...
This type is used to implement the <span class="c003">Lazy</span>[<a href="../../api/4.05/Lazy.html"><span class="c003">Lazy</span></a>] module.
...
<h2 class="section" id="sec528">2&nbsp;&nbsp;Module <span class="c003">Pervasives</span>: the initially opened module</h2>
<ul class="ftoc2"><li class="li-links">
<a href="../../api/4.05/Pervasives.html">Module <span class="c003">Pervasives</span>: the initially opened module</a>
</li></ul>
<hr>
