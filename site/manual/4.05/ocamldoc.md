...
<header><nav class="toc brand"><a class="brand" href="https://ocaml.org/"><img src="colour-logo-gray.svg" class="svg" alt="OCaml"></a></nav><nav class="toc"><div class="toc_version"><a href="/docs" id="version-select">Version 4.05</a></div><div class="toc_title"><a href="#">The documentation generator (ocamldoc)</a></div><ul><li class="top"><a href="#">Top</a></li>
<li><a href="ocamldoc.html#sec321">1&nbsp;&nbsp;Usage</a>
</li><li><a href="ocamldoc.html#sec333">2&nbsp;&nbsp;Syntax of documentation comments</a>
</li><li><a href="ocamldoc.html#sec348">3&nbsp;&nbsp;Custom generators</a>
</li><li><a href="ocamldoc.html#sec353">4&nbsp;&nbsp;Adding command line options</a>
</li></ul></nav></header>
<p> <a id="c:ocamldoc"></a>
...
when available.
The source code is always kept when a <span class="c003">.ml</span>
file is given, but is by default discarded when a <span class="c003">.mli</span> is given.
This option keeps the source code in all cases.</dd><dt class="dt-description"><span class="c013"><span class="c003">-load</span> <span class="c009">file</span></span></dt><dd class="dd-description">
...
Do not allow custom @-tags (see section <a href="#s%3Aocamldoc-tags">15.2.5</a>).</dd><dt class="dt-description"><span class="c006">-no-stop</span></dt><dd class="dd-description">
Keep elements placed after/between the <span class="c003">(**/**)</span> special comment(s)
(see section <a href="#s%3Aocamldoc-comments">15.2</a>).</dd><dt class="dt-description"><span class="c013"><span class="c003">-o</span> <span class="c009">file</span></span></dt><dd class="dd-description">
...
Allow arbitrary recursive types. (See the <span class="c003">-rectypes</span> option to <span class="c003">ocamlc</span>.)</dd></dl><h4 class="subsubsection" id="sec326">Options for generating HTML pages</h4>
...
</pre></dd></dl><h4 class="subsubsection" id="sec327">Options for generating L<sup>A</sup>T<sub>E</sub>X files</h4>
...
</dd></dl><h4 class="subsubsection" id="sec329">Options for generating <span class="c003">dot</span> graphs</h4>
...
<h4 class="subsubsection" id="sec335">Comments in <span class="c003">.mli</span> files</h4>
<p>
...
<h4 class="subsubsection" id="sec336">Comments in <span class="c003">.ml</span> files</h4>
...
for HTML&nbsp;: <a href="https://github.com/ocaml/ocaml/blob/4.05/ocamldoc/odoc_html.ml"><span class="c003">odoc_html.ml</span></a>,
</li><li class="li-itemize">for L<sup>A</sup>T<sub>E</sub>X&nbsp;: <a href="https://github.com/ocaml/ocaml/blob/4.05/ocamldoc/odoc_latex.ml"><span class="c003">odoc_latex.ml</span></a>,
</li><li class="li-itemize">for TeXinfo&nbsp;: <a href="https://github.com/ocaml/ocaml/blob/4.05/ocamldoc/odoc_texi.ml"><span class="c003">odoc_texi.ml</span></a>,
</li><li class="li-itemize">for man pages&nbsp;: <a href="https://github.com/ocaml/ocaml/blob/4.05/ocamldoc/odoc_man.ml"><span class="c003">odoc_man.ml</span></a>,
</li><li class="li-itemize">for graphviz (dot)&nbsp;: <a href="https://github.com/ocaml/ocaml/blob/4.05/ocamldoc/odoc_dot.ml"><span class="c003">odoc_dot.ml</span></a>.
</li></ul>
