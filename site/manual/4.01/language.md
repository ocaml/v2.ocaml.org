...
<p>The type <span class="c008">#</span> <a class="syntax" href="names.html#class-path"><span class="c014">class-path</span></a> is a special kind of abbreviation. This
...
<tr><td class="c023"><span class="c007">.   .(   .[   .{</span> (see section&nbsp;<a href="extn.html#s%3Abigarray-access">7.20</a>)</td><td class="c023">– </td></tr>
<tr><td class="c023"><span class="c007">#</span></td><td class="c023">– </td></tr>
...
<p>An expression consisting in a constant evaluates to this constant.</p><h4 class="subsubsection" id="expr:var">Value paths</h4>
...
is resumed against the patterns following <a class="syntax" href="patterns.html#pattern"><span class="c014">pattern</span></a><sub><span class="c013">i</span></sub>.</p><h4 class="subsubsection" id="s:localdef">Local definitions</h4>
<p><a id="hevea_manual.kwd44"></a></p><p>The <span class="c008">let</span> and <span class="c005"><span class="c007">let</span> <span class="c007">rec</span></span> constructs bind value names locally.
The construct
</p><div class="center">
...
(see
<a href="../../api/4.01/Oo.html">Module <span class="c007">Oo</span></a>). Inside a method, the expression
