...
<h1 class="chapter" id="sec302"><span>Chapter 12</span>&nbsp;&nbsp;Native-code compilation (ocamlopt)</h1>
<header><nav class="toc brand"><a class="brand" href="https://ocaml.org/"><img src="colour-logo-gray.svg" class="svg" alt="OCaml"></a></nav><nav class="toc"><div class="toc_version"><a href="/docs" id="version-select">Version 4.06</a></div><div class="toc_title"><a href="#">Native-code compilation (ocamlopt)</a></div><ul><li class="top"><a href="#">Top</a></li>
<li><a href="native.html#sec303">1&nbsp;&nbsp;Overview of the compiler</a>
</li><li><a href="native.html#sec304">2&nbsp;&nbsp;Options</a>
</li><li><a href="native.html#sec308">3&nbsp;&nbsp;Common errors</a>
</li><li><a href="native.html#sec309">4&nbsp;&nbsp;Running executables produced by ocamlopt</a>
</li><li><a href="native.html#sec310">5&nbsp;&nbsp;Compatibility with the bytecode compiler</a>
</li></ul></nav></header>
...
<h2 class="section" id="sec303">1&nbsp;&nbsp;Overview of the compiler</h2>
...
<h2 class="section" id="sec304">2&nbsp;&nbsp;Options</h2>
...
chapter&nbsp;<a href="parsing.html#c%3Aparsinglib">27</a>: <a href="../../api/4.06/Ast_mapper.html"> <span class="c003">Ast_mapper</span> </a>
,
...
system <span class="c003">threads</span> library described in chapter&nbsp;<a href="libthreads.html#c%3Athreads">31</a>.
...
<h5 class="paragraph" id="sec305">Options for the IA32 architecture</h5>
<p>
...
<h5 class="paragraph" id="sec306">Options for the AMD64 architecture</h5>
<p>
...
<h5 class="paragraph" id="sec307">Contextual control of command-line options</h5>
...
<h2 class="section" id="sec308">3&nbsp;&nbsp;Common errors</h2>
...
<h2 class="section" id="sec309">4&nbsp;&nbsp;Running executables produced by ocamlopt</h2>
...
<h2 class="section" id="sec310">5&nbsp;&nbsp;Compatibility with the bytecode compiler</h2>
<p>
