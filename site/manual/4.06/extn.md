...
<li><a href="extn.html#sec232">1&nbsp;&nbsp;Integer literals for types <span class="c003">int32</span>, <span class="c003">int64</span>
and <span class="c003">nativeint</span></a>
</li><li><a href="extn.html#sec233">2&nbsp;&nbsp;Recursive definitions of values</a>
</li><li><a href="extn.html#sec234">3&nbsp;&nbsp;Lazy patterns</a>
</li><li><a href="extn.html#sec235">4&nbsp;&nbsp;Recursive modules</a>
</li><li><a href="extn.html#sec236">5&nbsp;&nbsp;Private types</a>
</li><li><a href="extn.html#sec240">6&nbsp;&nbsp;Local opens for patterns</a>
</li><li><a href="extn.html#sec241">7&nbsp;&nbsp;Object copy short notations</a>
</li><li><a href="extn.html#sec242">8&nbsp;&nbsp;Locally abstract types</a>
</li><li><a href="extn.html#sec244">9&nbsp;&nbsp;First-class modules</a>
</li><li><a href="extn.html#sec247">10&nbsp;&nbsp;Recovering the type of a module</a>
</li><li><a href="extn.html#sec248">11&nbsp;&nbsp;Substituting inside a signature</a>
</li><li><a href="extn.html#sec249">12&nbsp;&nbsp;Type-level module aliases</a>
</li><li><a href="extn.html#sec250">13&nbsp;&nbsp;Overriding in open statements</a>
</li><li><a href="extn.html#sec251">14&nbsp;&nbsp;Generalized algebraic datatypes</a>
</li><li><a href="extn.html#sec258">15&nbsp;&nbsp;Syntax for Bigarray access</a>
</li><li><a href="extn.html#sec259">16&nbsp;&nbsp;Attributes</a>
</li><li><a href="extn.html#sec261">17&nbsp;&nbsp;Extension nodes</a>
</li><li><a href="extn.html#sec263">18&nbsp;&nbsp;Quoted strings</a>
</li><li><a href="extn.html#sec264">19&nbsp;&nbsp;Exception cases in pattern matching</a>
</li><li><a href="extn.html#sec265">20&nbsp;&nbsp;Extensible variant types</a>
</li><li><a href="extn.html#sec267">21&nbsp;&nbsp;Generative functors</a>
</li><li><a href="extn.html#sec268">22&nbsp;&nbsp;Extension-only syntax</a>
</li><li><a href="extn.html#sec271">23&nbsp;&nbsp;Inline records</a>
</li><li><a href="extn.html#sec272">24&nbsp;&nbsp;Local exceptions</a>
</li><li><a href="extn.html#sec273">25&nbsp;&nbsp;Documentation comments</a>
...
<h5 class="paragraph" id="sec257">Equations on non-local abstract types</h5>
...
<h2 class="section" id="sec258">15&nbsp;&nbsp;Syntax for Bigarray access</h2>
<p><a id="s:bigarray-access"></a></p><p>(Introduced in Objective Caml 3.00)</p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
<a class="syntax" href="expr.html#expr"><span class="c010">expr</span></a></td><td class="c015">::=</td><td class="c017">
...
&nbsp;</td></tr>
...
<span class="c003">Bigarray</span>[<a href="../../api/4.06/Bigarray.html"><span class="c003">Bigarray</span></a>] library.</p><p>The short expressions are translated into calls to functions of the
<span class="c003">Bigarray</span> module as described in the following table.</p><div class="center"><table class="c000 cellpadding1" border="1"><tbody><tr><td class="c014"><span class="c013">expression</span></td><td class="c014"><span class="c013">translation</span> </td></tr>
<tr><td class="c016">
...
</tbody></table></div><p>The last two entries are valid for any <span class="c009">n</span> &gt; 3.</p>
<h2 class="section" id="sec259">16&nbsp;&nbsp;Attributes</h2>
...
followed by a <span class="c003">when</span> clause:</p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
“algebraic” categories:</p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
</tbody></table><p>This form of attributes can also be inserted after the <span class="c004">`</span><a class="syntax" href="names.html#tag-name"><span class="c010">tag-name</span></a>
...
constructors in type declarations:</p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
declarations, class fields, etc:</p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
attached to any specific node in the syntax tree:</p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
</tbody></table><p>(Note: contrary to what the grammar above describes, <span class="c010">item-attributes</span>
...
<h3 class="subsection" id="sec260">16.1&nbsp;&nbsp;Built-in attributes</h3>
<p>
...
<a href="intfc.html#s%3AC-cheaper-call">20.10</a> for more details.
...
<h2 class="section" id="sec261">17&nbsp;&nbsp;Extension nodes</h2>
...
attributes&nbsp;<a href="#s%3Aattributes">8.16</a>.</p><p>The first form of extension node is used for “algebraic” categories:</p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
signatures, both in the module and object languages:</p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
<h3 class="subsection" id="sec262">17.1&nbsp;&nbsp;Built-in extension nodes</h3>
...
<h2 class="section" id="sec263">18&nbsp;&nbsp;Quoted strings</h2>
...
itself.</p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
</tbody></table><p>The opening delimiter has the form <span class="c003">{id|</span> where <span class="c003">id</span> is a (possibly
...
<h2 class="section" id="sec264">19&nbsp;&nbsp;Exception cases in pattern matching</h2>
...
are rejected by the type-checker).</p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
<a class="syntax" href="patterns.html#pattern"><span class="c010">pattern</span></a></td><td class="c015">::=</td><td class="c017">&nbsp;...
&nbsp;</td></tr>
...
matching.</p>
<h2 class="section" id="sec265">20&nbsp;&nbsp;Extensible variant types</h2>
<p><a id="s:extensible-variants"></a></p><p>(Introduced in OCaml 4.02)</p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
<a class="syntax" href="typedecl.html#type-representation"><span class="c010">type-representation</span></a></td><td class="c015">::=</td><td class="c017">
...
&nbsp;</td></tr>
...
<h3 class="subsection" id="sec266">20.1&nbsp;&nbsp;Private extensible variant types</h3>
<p>(Introduced in OCaml 4.06)</p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
<a class="syntax" href="typedecl.html#type-representation"><span class="c010">type-representation</span></a></td><td class="c015">::=</td><td class="c017">
...
&nbsp;</td></tr>
...
</tbody></table><p>Extensible variant types can be declared <span class="c003">private</span>. This prevents new
...
<h2 class="section" id="sec267">21&nbsp;&nbsp;Generative functors</h2>
<p><a id="s:generative-functors"></a></p><p>(Introduced in OCaml 4.02)</p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
<a class="syntax" href="modules.html#module-expr"><span class="c010">module-expr</span></a></td><td class="c015">::=</td><td class="c017">
...
&nbsp;</td></tr>
...
</tbody></table><p>A generative functor takes a unit <span class="c003">()</span> argument.
...
<h2 class="section" id="sec268">22&nbsp;&nbsp;Extension-only syntax</h2>
<p>
...
<h3 class="subsection" id="sec269">22.1&nbsp;&nbsp;Extension operators</h3>
<p> <a id="s:ext-ops"></a>
...
</tbody></table><p>Operator names starting with a <span class="c003">#</span> character and containing more than
one <span class="c003">#</span> character are reserved for extensions.</p>
<h3 class="subsection" id="sec270">22.2&nbsp;&nbsp;Extension literals</h3>
...
<h2 class="section" id="sec271">23&nbsp;&nbsp;Inline records</h2>
...
<h2 class="section" id="sec272">24&nbsp;&nbsp;Local exceptions</h2>
<p>
<a id="hevea_manual.kwd230"></a>
<a id="hevea_manual.kwd231"></a> <a id="s:local-exceptions"></a></p><p>(Introduced in OCaml 4.04)</p><p>It is possible to define local exceptions in expressions:</p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
<a class="syntax" href="expr.html#expr"><span class="c010">expr</span></a></td><td class="c015">::=</td><td class="c017">
...
&nbsp;</td></tr>
...
<h2 class="section" id="sec273">25&nbsp;&nbsp;Documentation comments</h2>
<p>
...
<h3 class="subsection" id="sec274">25.1&nbsp;&nbsp;Floating comments</h3>
...
<h3 class="subsection" id="sec275">25.2&nbsp;&nbsp;Item comments</h3>
...
<h3 class="subsection" id="sec276">25.3&nbsp;&nbsp;Label comments</h3>
...
<h2 class="section" id="s:index-operators">26&nbsp;&nbsp;Extended indexing operators  </h2>
<p>
(Introduced in 4.06)</p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018"><a class="syntax" id="dot-ext"><span class="c010">dot-ext</span></a></td><td class="c015">::=</td><td class="c017">
&nbsp;</td></tr>
...
</tbody></table><p>This extension provides syntactic sugar for getting and setting elements
