...
<header><nav class="toc brand"><a class="brand" href="https://ocaml.org/"><img src="colour-logo-gray.svg" class="svg" alt="OCaml"></a></nav><nav class="toc"><div class="toc_version"><a href="/docs" id="version-select">Version 4.06</a></div><div class="toc_title"><a href="#">Interfacing C with OCaml</a></div><ul><li class="top"><a href="#">Top</a></li>
<li><a href="intfc.html#sec413">1&nbsp;&nbsp;Overview and compilation information</a>
</li><li><a href="intfc.html#sec420">2&nbsp;&nbsp;The <span class="c003">value</span> type</a>
</li><li><a href="intfc.html#sec424">3&nbsp;&nbsp;Representation of OCaml data types</a>
</li><li><a href="intfc.html#sec431">4&nbsp;&nbsp;Operations on values</a>
</li><li><a href="intfc.html#sec439">5&nbsp;&nbsp;Living in harmony with the garbage collector</a>
</li><li><a href="intfc.html#sec447">6&nbsp;&nbsp;A complete example</a>
</li><li><a href="intfc.html#sec448">7&nbsp;&nbsp;Advanced topic: callbacks from C to OCaml</a>
</li><li><a href="intfc.html#sec458">8&nbsp;&nbsp;Advanced example with callbacks</a>
</li><li><a href="intfc.html#sec459">9&nbsp;&nbsp;Advanced topic: custom blocks</a>
</li><li><a href="intfc.html#sec466">10&nbsp;&nbsp;Advanced topic: cheaper C call</a>
</li><li><a href="intfc.html#sec470">11&nbsp;&nbsp;Advanced topic: multithreading</a>
</li><li><a href="intfc.html#sec473">12&nbsp;&nbsp;Advanced topic: interfacing with Windows Unicode APIs</a>
</li><li><a href="intfc.html#sec475">13&nbsp;&nbsp;Building mixed C/OCaml libraries: <span class="c003">ocamlmklib</span></a>
</li></ul></nav></header>
...
<h2 class="section" id="sec413">1&nbsp;&nbsp;Overview and compilation information</h2>
<h3 class="subsection" id="sec414">1.1&nbsp;&nbsp;Declaring primitives</h3>
...
<h3 class="subsection" id="sec415">1.2&nbsp;&nbsp;Implementing primitives</h3>
...
of multiple threads (see section&nbsp;<a href="#s%3AC-multithreading">20.11</a>). </td></tr>
</tbody></table></div><p>
...
compatibility.</p>
<h3 class="subsection" id="sec416">1.3&nbsp;&nbsp;Statically linking C code with OCaml code</h3>
<p>
...
library, however.</p>
<h3 class="subsection" id="sec417">1.4&nbsp;&nbsp;Dynamically linking C code with OCaml code</h3>
<p>
...
The <span class="c003">ocamlmklib</span> tool (see section&nbsp;<a href="#s-ocamlmklib">20.13</a>)
...
<h3 class="subsection" id="sec418">1.5&nbsp;&nbsp;Choosing between static linking and dynamic linking</h3>
...
(see section&nbsp;<a href="#s-ocamlmklib">20.13</a>) tries to hide some of these system
...
portable way.</p>
<h3 class="subsection" id="sec419">1.6&nbsp;&nbsp;Building standalone custom runtime systems</h3>
<p>
...
<h2 class="section" id="sec420">2&nbsp;&nbsp;The <span class="c003">value</span> type</h2>
...
<h3 class="subsection" id="sec423">2.3&nbsp;&nbsp;Pointers outside the heap</h3>
...
<h2 class="section" id="sec424">3&nbsp;&nbsp;Representation of OCaml data types</h2>
<p>This section describes how OCaml data types are encoded in the
<span class="c003">value</span> type.</p>
<h3 class="subsection" id="sec425">3.1&nbsp;&nbsp;Atomic types</h3>
...
<h3 class="subsection" id="sec426">3.2&nbsp;&nbsp;Tuples and records</h3>
<p>
...
<h3 class="subsection" id="sec427">3.3&nbsp;&nbsp;Arrays</h3>
...
<h3 class="subsection" id="sec428">3.4&nbsp;&nbsp;Concrete data types</h3>
...
<h3 class="subsection" id="sec429">3.5&nbsp;&nbsp;Objects</h3>
...
<h3 class="subsection" id="sec430">3.6&nbsp;&nbsp;Polymorphic variants</h3>
...
<h2 class="section" id="sec431">4&nbsp;&nbsp;Operations on values</h2>
<h3 class="subsection" id="sec432">4.1&nbsp;&nbsp;Kind tests</h3>
...
<h3 class="subsection" id="sec433">4.2&nbsp;&nbsp;Operations on integers</h3>
<ul class="itemize"><li class="li-itemize">
...
<h3 class="subsection" id="sec434">4.3&nbsp;&nbsp;Accessing blocks</h3>
<ul class="itemize"><li class="li-itemize">
...
below).</p>
<h3 class="subsection" id="sec435">4.4&nbsp;&nbsp;Allocating blocks</h3>
<h4 class="subsubsection" id="sec436">Simple interface</h4>
<ul class="itemize"><li class="li-itemize">
...
<h4 class="subsubsection" id="sec437">Low-level interface</h4>
...
<h3 class="subsection" id="sec438">4.5&nbsp;&nbsp;Raising exceptions</h3>
...
<h2 class="section" id="sec439">5&nbsp;&nbsp;Living in harmony with the garbage collector</h2>
...
<h3 class="subsection" id="sec440">5.1&nbsp;&nbsp;Simple interface</h3>
...
<h5 class="paragraph" id="sec441">Note:</h5>
...
<h5 class="paragraph" id="sec443">Warning:</h5>
...
<h5 class="paragraph" id="sec444">Use with CAMLlocalN:</h5>
...
<h5 class="paragraph" id="sec445">Note:</h5>
...
<h3 class="subsection" id="sec454">7.5&nbsp;&nbsp;Embedding the OCaml code in the C code</h3>
...
<h5 class="paragraph" id="sec457">Unloading the runtime.</h5>
...
<h2 class="section" id="sec458">8&nbsp;&nbsp;Advanced example with callbacks</h2>
...
<h2 class="section" id="sec459">9&nbsp;&nbsp;Advanced topic: custom blocks</h2>
<p> <a id="s:custom"></a>
...
<h3 class="subsection" id="sec460">9.1&nbsp;&nbsp;The <span class="c003">struct custom_operations</span></h3>
...
<h3 class="subsection" id="sec461">9.2&nbsp;&nbsp;Allocating custom blocks</h3>
...
<h3 class="subsection" id="sec462">9.3&nbsp;&nbsp;Accessing custom blocks</h3>
...
<h3 class="subsection" id="sec463">9.4&nbsp;&nbsp;Writing custom serialization and deserialization functions</h3>
...
written on a little-endian machine and read back on a big-endian machine.</p><div class="center"><table class="c000 cellpadding1" border="1"><tbody><tr><td class="c014"><span class="c013">Function</span></td><td class="c014"><span class="c013">Action</span> </td></tr>
<tr><td class="c022">
...
<h3 class="subsection" id="sec464">9.5&nbsp;&nbsp;Choosing identifiers</h3>
...
<h3 class="subsection" id="sec465">9.6&nbsp;&nbsp;Finalized blocks</h3>
...
size <span class="c009">n</span> words, with finalization function <span class="c009">f</span>. The first
word is reserved for storing the custom operations; the other
<span class="c009">n</span>-1 words are available for your data. The two parameters
...
<h2 class="section" id="sec466">10&nbsp;&nbsp;Advanced topic: cheaper C call</h2>
<p>
...
<h3 class="subsection" id="sec467">10.1&nbsp;&nbsp;Passing unboxed values</h3>
...
what C types should be used in correspondence:</p><div class="center"><table class="c000 cellpadding1" border="1"><tbody><tr><td class="c014"><span class="c013">OCaml type</span></td><td class="c014"><span class="c013">C type</span> </td></tr>
<tr><td class="c016">
...
<h3 class="subsection" id="sec468">10.2&nbsp;&nbsp;Direct C call</h3>
...
<h3 class="subsection" id="sec469">10.3&nbsp;&nbsp;Example: calling C library functions without indirection</h3>
...
<h2 class="section" id="sec470">11&nbsp;&nbsp;Advanced topic: multithreading</h2>
<p>
...
section.</p>
<h3 class="subsection" id="sec471">11.1&nbsp;&nbsp;Registering threads created from C</h3>
...
<h3 class="subsection" id="sec472">11.2&nbsp;&nbsp;Parallel execution of long-running C code</h3>
...
<h2 class="section" id="sec473">12&nbsp;&nbsp;Advanced topic: interfacing with Windows Unicode APIs</h2>
<p>
...
<h5 class="paragraph" id="sec474">Example</h5>
...
<h2 class="section" id="sec475">13&nbsp;&nbsp;Building mixed C/OCaml libraries: <span class="c003">ocamlmklib</span></h2>
<p>
...
<h5 class="paragraph" id="sec476">Example</h5>
