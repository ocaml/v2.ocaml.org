...
<li><a href="#sec73">1&nbsp;&nbsp;Lexical conventions</a>
</li><li><a href="#sec86">2&nbsp;&nbsp;Values</a>
</li><li><a href="#sec99">3&nbsp;&nbsp;Names</a>
</li><li><a href="#sec102">4&nbsp;&nbsp;Type expressions</a>
</li><li><a href="#sec113">5&nbsp;&nbsp;Constants</a>
</li><li><a href="#sec114">6&nbsp;&nbsp;Patterns</a>
</li><li><a href="#s:value-expr">7&nbsp;&nbsp;Expressions</a>
</li><li><a href="#sec167">8&nbsp;&nbsp;Type and exception definitions</a>
</li><li><a href="#sec170">9&nbsp;&nbsp;Classes</a>
</li><li><a href="#sec201">10&nbsp;&nbsp;Module types (module specifications)</a>
</li><li><a href="#s:module-expr">11&nbsp;&nbsp;Module expressions (module implementations)</a>
</li><li><a href="#sec230">12&nbsp;&nbsp;Compilation units</a>
</li></ul></nav></header>
...
<ul>
<li><a href="#sec87">2.1&nbsp;&nbsp;Base values</a>
</li><li><a href="#sec92">2.2&nbsp;&nbsp;Tuples</a>
</li><li><a href="#sec93">2.3&nbsp;&nbsp;Records</a>
</li><li><a href="#sec94">2.4&nbsp;&nbsp;Arrays</a>
</li><li><a href="#sec95">2.5&nbsp;&nbsp;Variant values</a>
</li><li><a href="#sec96">2.6&nbsp;&nbsp;Polymorphic variants</a>
</li><li><a href="#sec97">2.7&nbsp;&nbsp;Functions</a>
</li><li><a href="#sec98">2.8&nbsp;&nbsp;Objects</a>
</li></ul>
...
<h2 class="section" id="sec99">3&nbsp;&nbsp;Names</h2>
<p> <a id="s:names"></a>
...
lowercase letter for this purpose.</p><h4 class="subsubsection" id="sec100">Naming objects</h4>
<p>
...
compatibility with future OCaml versions.</p><h4 class="subsubsection" id="sec101">Referring to named objects</h4>
<table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
<h2 class="section" id="sec102">4&nbsp;&nbsp;Type expressions</h2>
<p>
...
in type constraints over patterns and expressions.</p><h4 class="subsubsection" id="sec103">Type variables</h4>
...
defined types.)</p><h4 class="subsubsection" id="sec104">Parenthesized types</h4>
...
<a class="syntax" href="#typexpr"><span class="c010">typexpr</span></a>.</p><h4 class="subsubsection" id="sec105">Function types</h4>
...
<a class="syntax" href="#typexpr"><span class="c010">typexpr</span></a><sub>1</sub> <span class="c002"><span class="c003">option</span> <span class="c003">-&gt;</span></span> &nbsp;<a class="syntax" href="#typexpr"><span class="c010">typexpr</span></a><sub>2</sub>.</p><h4 class="subsubsection" id="sec106">Tuple types</h4>
...
… &nbsp;<a class="syntax" href="#typexpr"><span class="c010">typexpr</span></a><sub><span class="c009">n</span></sub> respectively.</p><h4 class="subsubsection" id="sec107">Constructed types</h4>
...
<a class="syntax" href="names.html#typeconstr"><span class="c010">typeconstr</span></a>.</p><h4 class="subsubsection" id="sec108">Aliased and recursive types</h4>
...
of <a class="syntax" href="#typexpr"><span class="c010">typexpr</span></a> is captured by <span class="c004">'</span> <a class="syntax" href="lex.html#ident"><span class="c010">ident</span></a>, and quantified upon.</p><h4 class="subsubsection" id="sec109">Polymorphic variant types</h4>
<p>
...
may cause early failures.</p><h4 class="subsubsection" id="sec110">Object types</h4>
<p>An object type
...
literature) that stands for any number of extra method types.</p><h4 class="subsubsection" id="sec111">#-types</h4>
<p>
...
<span class="c002"><span class="c003">[&lt;</span> <span class="c010">t</span> <span class="c003">&gt;</span> <span class="c003">`</span></span><a class="syntax" href="names.html#tag-name"><span class="c010">tag</span></a><sub>1</sub> …<span class="c004">`</span>&nbsp;<a class="syntax" href="names.html#tag-name"><span class="c010">tag</span></a><sub><span class="c009">k</span></sub><span class="c004">]</span></p><h4 class="subsubsection" id="sec112">Variant and record types</h4>
...
<h2 class="section" id="sec113">5&nbsp;&nbsp;Constants</h2>
...
<h2 class="section" id="sec114">6&nbsp;&nbsp;Patterns</h2>
<p>
...
of names to values”.</p><h4 class="subsubsection" id="sec115">Variable patterns</h4>
...
<span class="c004">when</span> guards can be used for this purpose).</p><h4 class="subsubsection" id="sec116">Constant patterns</h4>
<p>A pattern consisting in a constant matches the values that
are equal to this constant.</p><h4 class="subsubsection" id="sec117">Alias patterns</h4>
<p>
...
bindings performed by the matching against <a class="syntax" href="#pattern"><span class="c010">pattern</span></a><sub>1</sub>.</p><h4 class="subsubsection" id="sec118">Parenthesized patterns</h4>
...
<a class="syntax" href="types.html#typexpr"><span class="c010">typexpr</span></a>.</p><h4 class="subsubsection" id="sec119">“Or” patterns</h4>
...
Otherwise, value&nbsp;<span class="c009">v</span> matches <a class="syntax" href="#pattern"><span class="c010">pattern</span></a><sub>2</sub> whose bindings are performed.</p><h4 class="subsubsection" id="sec120">Variant patterns</h4>
...
<a class="syntax" href="#pattern"><span class="c010">pattern</span></a><sub>1</sub> <span class="c004">::</span> … <span class="c004">::</span> &nbsp;<a class="syntax" href="#pattern"><span class="c010">pattern</span></a><sub><span class="c009">n</span></sub> <span class="c002"><span class="c003">::</span> <span class="c003">[]</span></span>.</p><h4 class="subsubsection" id="sec121">Polymorphic variant patterns</h4>
...
<a class="syntax" href="#pattern"><span class="c010">pattern</span></a><sub>1</sub>.</p><h4 class="subsubsection" id="sec122">Polymorphic variant abbreviation patterns</h4>
...
<a class="syntax" href="#pattern"><span class="c010">pattern</span></a><sub><span class="c009">i</span></sub> matches <span class="c009">v</span><sub><span class="c009">i</span></sub> for <span class="c009">i</span> = 1,… , <span class="c009">n</span>.</p><h4 class="subsubsection" id="sec124">Record patterns</h4>
...
of <a class="syntax" href="names.html#field"><span class="c010">field</span></a><sub><span class="c009">k</span></sub> to be compatible with <a class="syntax" href="types.html#typexpr"><span class="c010">typexpr</span></a><sub><span class="c009">k</span></sub>.</p><h4 class="subsubsection" id="sec125">Array patterns</h4>
...
matches the pattern <a class="syntax" href="#pattern"><span class="c010">pattern</span></a><sub><span class="c009">i</span></sub>, for <span class="c009">i</span> = 1,… , <span class="c009">n</span>.</p><h4 class="subsubsection" id="sec126">Range patterns</h4>
<p>The pattern
...
<ul>
<li><a href="#sec128">7.1&nbsp;&nbsp;Basic expressions</a>
</li><li><a href="#sec137">7.2&nbsp;&nbsp;Control structures</a>
</li><li><a href="#sec144">7.3&nbsp;&nbsp;Operations on data structures</a>
</li><li><a href="#sec151">7.4&nbsp;&nbsp;Operators</a>
</li><li><a href="#sec152">7.5&nbsp;&nbsp;Objects</a>
</li><li><a href="#sec158">7.6&nbsp;&nbsp;Coercions</a>
</li><li><a href="#sec162">7.7&nbsp;&nbsp;Other</a>
</li></ul>
<p>
...
<h3 class="subsection" id="sec144">7.3&nbsp;&nbsp;Operations on data structures</h3>
...
<h3 class="subsection" id="sec152">7.5&nbsp;&nbsp;Objects</h3>
...
(see
<a href="../../api/4.06/Oo.html">Module <span class="c003">Oo</span></a>). Inside a method, the expression
...
<h3 class="subsection" id="sec158">7.6&nbsp;&nbsp;Coercions</h3>
...
<h3 class="subsection" id="sec162">7.7&nbsp;&nbsp;Other</h3>
...
<ul>
<li><a href="#sec168">8.1&nbsp;&nbsp;Type definitions</a>
</li><li><a href="#sec169">8.2&nbsp;&nbsp;Exception definitions</a>
</li></ul>
...
<ul>
<li><a href="#sec171">9.1&nbsp;&nbsp;Class types</a>
</li><li><a href="#sec181">9.2&nbsp;&nbsp;Class expressions</a>
</li><li><a href="#sec196">9.3&nbsp;&nbsp;Class definitions</a>
</li><li><a href="#sec199">9.4&nbsp;&nbsp;Class specifications</a>
</li><li><a href="#sec200">9.5&nbsp;&nbsp;Class type definitions</a>
</li></ul>
<p>
...
<h2 class="section" id="sec201">10&nbsp;&nbsp;Module types (module specifications)</h2>
<ul>
<li><a href="#sec202">10.1&nbsp;&nbsp;Simple module types</a>
</li><li><a href="#sec203">10.2&nbsp;&nbsp;Signatures</a>
</li><li><a href="#sec213">10.3&nbsp;&nbsp;Functor types</a>
</li><li><a href="#sec214">10.4&nbsp;&nbsp;The <span class="c003">with</span> operator</a>
</li></ul>
...
<a id="hevea_manual.kwd160"></a></p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
<h3 class="subsection" id="sec202">10.1&nbsp;&nbsp;Simple module types</h3>
...
<h3 class="subsection" id="sec203">10.2&nbsp;&nbsp;Signatures</h3>
...
meaning.</p><h4 class="subsubsection" id="sec204">Value specifications</h4>
...
(see chapter&nbsp;<a href="intfc.html#c%3Aintf-c">20</a>).</p><h4 class="subsubsection" id="sec205">Type specifications</h4>
...
</dd></dl><h4 class="subsubsection" id="sec206">Exception specification</h4>
...
users of the structure.</p><h4 class="subsubsection" id="sec207">Class specifications</h4>
...
section&nbsp;<a href="classes.html#s%3Aclass-spec">7.9.4</a>.</p><h4 class="subsubsection" id="sec208">Class type specifications</h4>
...
section&nbsp;<a href="classes.html#s%3Aclasstype">7.9.5</a>.</p><h4 class="subsubsection" id="sec209">Module specifications</h4>
...
<span class="c004">-&gt;</span> &nbsp;<a class="syntax" href="#module-type"><span class="c010">module-type</span></a>
</div><h4 class="subsubsection" id="sec210">Module type specifications</h4>
...
<h4 class="subsubsection" id="sec211">Opening a module path</h4>
...
<h4 class="subsubsection" id="sec212">Including a signature</h4>
...
<h3 class="subsection" id="sec213">10.3&nbsp;&nbsp;Functor types</h3>
...
<h3 class="subsection" id="sec214">10.4&nbsp;&nbsp;The <span class="c003">with</span> operator</h3>
...
<ul>
<li><a href="#sec216">11.1&nbsp;&nbsp;Simple module expressions</a>
</li><li><a href="#sec217">11.2&nbsp;&nbsp;Structures</a>
</li><li><a href="#sec227">11.3&nbsp;&nbsp;Functors</a>
</li></ul>
...
<a id="hevea_manual.kwd188"></a></p><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
<a href="extn.html#s%3Aextension-nodes">extension nodes</a> and
<a href="extn.html#s%3Agenerative-functors">generative functors</a>.</p>
<h3 class="subsection" id="sec216">11.1&nbsp;&nbsp;Simple module expressions</h3>
...
<h3 class="subsection" id="sec217">11.2&nbsp;&nbsp;Structures</h3>
...
the first component of a structure, the preceding <span class="c003">;;</span> can be omitted.</p><h4 class="subsubsection" id="sec218">Value definitions</h4>
...
<a class="syntax" href="intfc.html#external-declaration"><span class="c010">external-declaration</span></a> (see chapter&nbsp;<a href="intfc.html#c%3Aintf-c">20</a>).</p><h4 class="subsubsection" id="sec219">Type definitions</h4>
...
of mutually recursive definitions of type names.</p><h4 class="subsubsection" id="sec220">Exception definitions</h4>
...
or <span class="c004">exception</span> <a class="syntax" href="names.html#constr-name"><span class="c010">constr-name</span></a> <span class="c004">=</span> &nbsp;<a class="syntax" href="names.html#constr"><span class="c010">constr</span></a>.</p><h4 class="subsubsection" id="sec221">Class definitions</h4>
...
described more precisely in section&nbsp;<a href="classes.html#s%3Aclassdef">7.9.3</a>.</p><h4 class="subsubsection" id="sec222">Class type definitions</h4>
...
section&nbsp;<a href="classes.html#s%3Aclasstype">7.9.5</a>.</p><h4 class="subsubsection" id="sec223">Module definitions</h4>
...
</div><h4 class="subsubsection" id="sec224">Module type definitions</h4>
...
expression <a class="syntax" href="modtypes.html#module-type"><span class="c010">module-type</span></a>.</p><h4 class="subsubsection" id="sec225">Opening a module path</h4>
...
the <span class="c004">open</span> stops at the end of the structure expression.</p><h4 class="subsubsection" id="sec226">Including the components of another structure</h4>
...
<h3 class="subsection" id="sec227">11.3&nbsp;&nbsp;Functors</h3>
<h4 class="subsubsection" id="sec228">Functor definition</h4>
...
argument (“higher-order” functor).</p><h4 class="subsubsection" id="sec229">Functor application</h4>
...
<h2 class="section" id="sec230">12&nbsp;&nbsp;Compilation units</h2>
<table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
