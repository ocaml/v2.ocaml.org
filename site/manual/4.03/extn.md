...
</li><li><a href="#sec244">Syntax for Bigarray access</a>
</li><li><a href="#sec245">Attributes</a>
</li><li><a href="#sec247">Extension nodes</a>
</li><li><a href="#sec249">Quoted strings</a>
</li><li><a href="#sec250">Exception cases in pattern matching</a>
</li><li><a href="#sec251">Extensible variant types</a>
</li><li><a href="#sec252">Generative functors</a>
</li><li><a href="#sec253">Extension-only syntax</a>
</li><li><a href="#sec256">Inline records</a>
</li><li><a href="#sec257">Documentation comments</a>
</li></ul></nav></header>
...
<p><a id="p:existential-names"></a></p><p>(Updated in OCaml 4.03.0)</p><p>The typing of pattern matching in presence of GADT can generate many
...
<h2 class="section" id="sec244">17&nbsp;&nbsp;Syntax for Bigarray access</h2>
...
<span class="c006">Bigarray</span>[<a href="../../api/4.03/Bigarray.html"><span class="c006">Bigarray</span></a>] library.</p><p>The short expressions are translated into calls to functions of the
...
<h2 class="section" id="sec245">18&nbsp;&nbsp;Attributes</h2>
<p><a id="s:attributes"></a></p><p>(Introduced in OCaml 4.02,
...
<span class="c007">exception</span>&nbsp;<a class="syntax" href="names.html#constr-name"><span class="c013">constr-name</span></a>&nbsp;&nbsp;{&nbsp;<a class="syntax" href="#attribute"><span class="c013">attribute</span></a>&nbsp;}&nbsp;&nbsp;[&nbsp;<span class="c007">of</span>&nbsp;<a class="syntax" href="types.html#typexpr"><span class="c013">typexpr</span></a>&nbsp;&nbsp;{&nbsp;<span class="c007">*</span>&nbsp;<a class="syntax" href="types.html#typexpr"><span class="c013">typexpr</span></a>&nbsp;}&nbsp;]
&nbsp;</td></tr>
...
<h3 class="subsection" id="sec246">18.1&nbsp;&nbsp;Built-in attributes</h3>
<p>
...
<h2 class="section" id="sec247">19&nbsp;&nbsp;Extension nodes</h2>
...
<h3 class="subsection" id="sec248">19.1&nbsp;&nbsp;Built-in extension nodes</h3>
...
<h2 class="section" id="sec249">20&nbsp;&nbsp;Quoted strings</h2>
...
<h2 class="section" id="sec250">21&nbsp;&nbsp;Exception cases in pattern matching</h2>
...
matching.</p>
<h2 class="section" id="sec251">22&nbsp;&nbsp;Extensible variant types</h2>
...
pattern-matching.</p>
<h2 class="section" id="sec252">23&nbsp;&nbsp;Generative functors</h2>
...
<h2 class="section" id="sec253">24&nbsp;&nbsp;Extension-only syntax</h2>
<p>
...
<h3 class="subsection" id="sec254">24.1&nbsp;&nbsp;Extension operators</h3>
<p> <a id="s:ext-ops"></a>
...
<h3 class="subsection" id="sec255">24.2&nbsp;&nbsp;Extension literals</h3>
<p>
...
<h2 class="section" id="sec256">25&nbsp;&nbsp;Inline records</h2>
<p>
(Introduced in OCaml 4.03)
</p><table class="display dcenter"><tbody><tr class="c022"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c021">
...
<h2 class="section" id="sec257">26&nbsp;&nbsp;Documentation comments</h2>
<p>
...
<h3 class="subsection" id="sec258">26.1&nbsp;&nbsp;Floating comments</h3>
...
<h3 class="subsection" id="sec259">26.2&nbsp;&nbsp;Item comments</h3>
...
<h3 class="subsection" id="sec260">26.3&nbsp;&nbsp;Label comments</h3>
