...
<ul>
<li><a href="#sec133">7.1&nbsp;&nbsp;Precedence and associativity</a>
</li><li><a href="#sec134">7.2&nbsp;&nbsp;Basic expressions</a>
</li><li><a href="#sec143">7.3&nbsp;&nbsp;Control structures</a>
</li><li><a href="#sec150">7.4&nbsp;&nbsp;Operations on data structures</a>
</li><li><a href="#sec157">7.5&nbsp;&nbsp;Operators</a>
</li><li><a href="#sec158">7.6&nbsp;&nbsp;Objects</a>
</li><li><a href="#sec164">7.7&nbsp;&nbsp;Coercions</a>
</li><li><a href="#sec168">7.8&nbsp;&nbsp;Other</a>
</li></ul>
<p>
...
interpreted respectively as the functions <span class="c004">(~-)</span> and <span class="c004">(~-.)</span>.</p><p><a id="hevea_manual.kwd76"></a><a id="hevea_manual.kwd77"></a><a id="hevea_manual.kwd78"></a><a id="hevea_manual.kwd79"></a><a id="hevea_manual.kwd80"></a><a id="hevea_manual.kwd81"></a><a id="hevea_manual.kwd82"></a></p><div class="tableau">
...
<h3 class="subsection" id="sec158">7.6&nbsp;&nbsp;Objects</h3>
<p> <a id="s:objects"></a></p><h4 class="subsubsection" id="sec159">Object creation</h4>
<p><a id="hevea_manual.kwd83"></a></p><p>When <a class="syntax" href="names.html#class-path"><span class="c010">class-path</span></a> evaluates to a class body, <span class="c004">new</span> <a class="syntax" href="names.html#class-path"><span class="c010">class-path</span></a>
...
returning a new object of this class.</p><h4 class="subsubsection" id="sec160">Immediate object creation</h4>
<p><a id="hevea_manual.kwd84"></a></p><p>Creating directly an object through the <span class="c004">object</span> <a class="syntax" href="classes.html#class-body"><span class="c010">class-body</span></a> <span class="c004">end</span>
...
with a closed object type.</p><h4 class="subsubsection" id="sec161">Method invocation</h4>
...
checked in the <span class="c003">-principal</span> mode.</p><h4 class="subsubsection" id="sec162">Accessing and modifying instance variables</h4>
...
<a class="syntax" href="names.html#inst-var-name"><span class="c010">inst-var-name</span></a> <span class="c004">&lt;-</span> &nbsp;<a class="syntax" href="#expr"><span class="c010">expr</span></a> evaluates to <span class="c004">()</span>.</p><h4 class="subsubsection" id="sec163">Object duplication</h4>
<p>An object can be duplicated using the library function <span class="c003">Oo.copy</span>
(see module <a href="../../api/4.09/Oo.html"><span class="c003">Oo</span></a>). Inside a method, the expression
...
<h3 class="subsection" id="sec164">7.7&nbsp;&nbsp;Coercions</h3>
...
In the following paragraphs we describe the subtyping relation used.</p><h4 class="subsubsection" id="sec165">Object types</h4>
...
there are no binary methods.</p><h4 class="subsubsection" id="sec166">Polymorphic variant types</h4>
...
which may be an extensible type, if every <a class="syntax" href="types.html#typexpr"><span class="c010">typ</span></a><sub><span class="c009">i</span></sub> is a subtype of <a class="syntax" href="types.html#typexpr"><span class="c010">typ</span></a>′<sub><span class="c009">i</span></sub>.</p><h4 class="subsubsection" id="sec167">Variance</h4>
...
<h3 class="subsection" id="sec168">7.8&nbsp;&nbsp;Other</h3>
<h4 class="subsubsection" id="sec169">Assertion checking</h4>
<p><a id="hevea_manual.kwd85"></a></p><p>OCaml supports the <span class="c004">assert</span> construct to check debugging assertions.
...
<a id="hevea_manual5"></a></p><h4 class="subsubsection" id="sec170">Lazy expressions</h4>
<p>
<a id="hevea_manual.kwd86"></a></p><p>The expression <span class="c004">lazy</span> <a class="syntax" href="#expr"><span class="c010">expr</span></a> returns a value <span class="c009">v</span> of type <span class="c003">Lazy.t</span> that
...
of <span class="c003">Lazy.force</span> may be implicit through pattern matching (see&nbsp;<a href="patterns.html#s%3Alazypat">7.6</a>).</p><h4 class="subsubsection" id="sec171">Local modules</h4>
<p>
<a id="hevea_manual.kwd87"></a>
<a id="hevea_manual.kwd88"></a></p><p>The expression
...
<pre><code class="caml-input"><span class="text"> </span><span class="kw">let</span><span class="text"> </span><span class="id">remove_duplicates</span><span class="text"> </span><span class="id">comparison_fun</span><span class="text"> </span><span class="id">string_list</span><span class="text"> =
   </span><span class="kw">let</span><span class="text"> </span><span class="kw">module</span><span class="text"> </span><span class="kw2">StringSet</span><span class="text"> =
     </span><span class="kw2">Set</span><span class="text">.</span><span class="kw2">Make</span><span class="text">(</span><span class="kw1">struct</span><span class="text"> </span><span class="kw">type</span><span class="text"> </span><span class="id">t</span><span class="text"> = </span><span class="kw3">string</span><span class="text">
                     </span><span class="kw">let</span><span class="text"> </span><span class="id">compare</span><span class="text"> = </span><span class="id">comparison_fun</span><span class="text"> </span><span class="kw1">end</span><span class="text">) </span><span class="kw">in</span><span class="text">
   </span><span class="kw2">StringSet</span><span class="text">.</span><span class="id">elements</span><span class="text">
     (</span><span class="kw2">List</span><span class="text">.</span><span class="id">fold_right</span><span class="text"> </span><span class="kw2">StringSet</span><span class="text">.</span><span class="id">add</span><span class="text"> </span><span class="id">string_list</span><span class="text"> </span><span class="kw2">StringSet</span><span class="text">.</span><span class="id">empty</span><span class="text">)
</span></code><code class="caml-output ok">val remove_duplicates :
  (string -&gt; string -&gt; int) -&gt; string list -&gt; string list = &lt;fun&gt;
</code></pre>


</div><h4 class="subsubsection" id="sec172">Local opens</h4>
<p>
<a id="hevea_manual.kwd89"></a>
<a id="hevea_manual.kwd90"></a></p><p>The expressions <span class="c002"><span class="c003">let</span> <span class="c003">open</span></span> <a class="syntax" href="names.html#module-path"><span class="c010">module-path</span></a> <span class="c004">in</span> &nbsp;<a class="syntax" href="#expr"><span class="c010">expr</span></a> and
...
<h2 class="section" id="sec173">8&nbsp;&nbsp;Type and exception definitions</h2>
<ul>
<li><a href="#sec174">8.1&nbsp;&nbsp;Type definitions</a>
</li><li><a href="#sec175">8.2&nbsp;&nbsp;Exception definitions</a>
</li></ul>

<h3 class="subsection" id="sec174">8.1&nbsp;&nbsp;Type definitions</h3>
<p>
...
associated with the definition.</p><p><a id="hevea_manual.kwd91"></a>
<a id="hevea_manual.kwd92"></a>
<a id="hevea_manual.kwd93"></a>
<a id="hevea_manual.kwd94"></a></p><div class="syntax"><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
See also the following language extensions:
<a href="manual025.html#s%3Aprivate-types">private types</a>,
<a href="manual033.html#s%3Agadts">generalized algebraic datatypes</a>,
<a href="manual035.html#s%3Aattributes">attributes</a>,
<a href="manual036.html#s%3Aextension-nodes">extension nodes</a>,
<a href="manual037.html#s%3Aextensible-variants">extensible variant types</a> and
<a href="manual040.html#s%3Ainline-records">inline records</a>.</p><p>Type definitions are introduced by the <span class="c003">type</span> keyword, and
...
checking the validity of <span class="c004">:&gt;</span> coercions (see section <a href="expr.html#s%3Acoercions">7.7.7</a>).</p><p>For instance, <span class="c003">type +'a t</span> declares <span class="c003">t</span> as an abstract type that is
...
only checked for conformance with the definition.</p><p><a id="hevea_manual.kwd98"></a>
...
<h3 class="subsection" id="sec175">8.2&nbsp;&nbsp;Exception definitions</h3>
<p> <a id="s:excdef"></a>
<a id="hevea_manual.kwd99"></a></p><div class="syntax"><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
<h2 class="section" id="sec176">9&nbsp;&nbsp;Classes</h2>
<ul>
<li><a href="#sec177">9.1&nbsp;&nbsp;Class types</a>
</li><li><a href="#sec187">9.2&nbsp;&nbsp;Class expressions</a>
</li><li><a href="#sec202">9.3&nbsp;&nbsp;Class definitions</a>
</li><li><a href="#sec205">9.4&nbsp;&nbsp;Class specifications</a>
</li><li><a href="#sec206">9.5&nbsp;&nbsp;Class type definitions</a>
</li></ul>
<p>
Classes are defined using a small language, similar to the module
language.</p>
<h3 class="subsection" id="sec177">9.1&nbsp;&nbsp;Class types</h3>
<p>Class types are the class-level equivalent of type expressions: they
specify the general shape and type properties of classes.</p><p><a id="hevea_manual.kwd100"></a>
...
<a id="hevea_manual.kwd108"></a></p><div class="syntax"><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
See also the following language extensions:
<a href="manual035.html#s%3Aattributes">attributes</a> and
<a href="manual036.html#s%3Aextension-nodes">extension nodes</a>.</p><h4 class="subsubsection" id="sec178">Simple class expressions</h4>
...
…<a class="syntax" href="types.html#typexpr"><span class="c010">typexpr</span></a><sub><span class="c009">n</span></sub>.</p><h4 class="subsubsection" id="sec179">Class function type</h4>
...
type <a class="syntax" href="#class-type"><span class="c010">class-type</span></a>.</p><h4 class="subsubsection" id="sec180">Class body type</h4>
...
mutable instance variable.</p><h4 class="subsubsection" id="sec181">Local opens</h4>
<p>Local opens are supported in class types since OCaml 4.06.</p><h4 class="subsubsection" id="sec182">Inheritance</h4>
<p><a id="hevea_manual.kwd109"></a></p><p>The inheritance construct <span class="c004">inherit</span> <a class="syntax" href="#class-body-type"><span class="c010">class-body-type</span></a> provides for inclusion of
...
into the current class type.</p><h4 class="subsubsection" id="sec183">Instance variable specification</h4>
<p><a id="hevea_manual.kwd110"></a>
<a id="hevea_manual.kwd111"></a></p><p>A specification of an instance variable is written
...
specification of an instance variable of the same name.</p><h4 class="subsubsection" id="sec184">Method specification</h4>
<p>
<a id="sec-methspec"></a></p><p><a id="hevea_manual.kwd112"></a>
<a id="hevea_manual.kwd113"></a></p><p>The specification of a method is written
...
Any non-private specification of a method forces it to be public.</p><h4 class="subsubsection" id="sec185">Virtual method specification</h4>
<p><a id="hevea_manual.kwd114"></a>
<a id="hevea_manual.kwd115"></a></p><p>A virtual method specification is written <span class="c004">method</span> [<span class="c004">private</span>]
...
name of the method and <a class="syntax" href="types.html#poly-typexpr"><span class="c010">poly-typexpr</span></a> its expected type.</p><h4 class="subsubsection" id="sec186">Constraints on type parameters</h4>
<p><a id="hevea_manual.kwd116"></a></p><p>The construct <span class="c004">constraint</span> <a class="syntax" href="types.html#typexpr"><span class="c010">typexpr</span></a><sub>1</sub> <span class="c004">=</span> &nbsp;<a class="syntax" href="types.html#typexpr"><span class="c010">typexpr</span></a><sub>2</sub> forces the two
...
expressions.</p>
<h3 class="subsection" id="sec187">9.2&nbsp;&nbsp;Class expressions</h3>
...
specifications expressed in class types.</p><p><a id="hevea_manual.kwd117"></a>
...
<a id="hevea_manual.kwd129"></a></p><div class="syntax"><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
See also the following language extensions:
<a href="manual027.html#s%3Alocally-abstract">locally abstract types</a>,
<a href="manual035.html#s%3Aattributes">attributes</a> and
<a href="manual036.html#s%3Aextension-nodes">extension nodes</a>.</p><h4 class="subsubsection" id="sec188">Simple class expressions</h4>
...
<a class="syntax" href="#class-type"><span class="c010">class-type</span></a> are hidden and can no longer be accessed.</p><h4 class="subsubsection" id="sec189">Class application</h4>
...
creation time.</p><h4 class="subsubsection" id="sec190">Class function</h4>
...
</div><h4 class="subsubsection" id="sec191">Local definitions</h4>
...
Otherwise, it will be evaluated when the object constructor is called.</p><h4 class="subsubsection" id="sec192">Local opens</h4>
...
variable name is defined several times in the same class body.</p><h4 class="subsubsection" id="sec194">Inheritance</h4>
<p><a id="hevea_manual.kwd130"></a></p><p>The inheritance construct <span class="c004">inherit</span> <a class="syntax" href="#class-expr"><span class="c010">class-expr</span></a> allows reusing
...
previously defined method of the same name.</p><p><a id="hevea_manual.kwd131"></a>
...
The ancestor method may be called from a subclass but only indirectly.</p><h4 class="subsubsection" id="sec195">Instance variable definition</h4>
<p><a id="hevea_manual.kwd132"></a>
<a id="hevea_manual.kwd133"></a></p><p>The definition <span class="c004">val</span> [<span class="c004">mutable</span>] <a class="syntax" href="names.html#inst-var-name"><span class="c010">inst-var-name</span></a> <span class="c004">=</span> &nbsp;<a class="syntax" href="expr.html#expr"><span class="c010">expr</span></a> adds an
...
other instance variables with the same name.</p><h4 class="subsubsection" id="sec196">Virtual instance variable definition</h4>
<p><a id="hevea_manual.kwd134"></a>
<a id="hevea_manual.kwd135"></a></p><p>A variable specification is written <span class="c004">val</span> [<span class="c004">mutable</span>] <span class="c004">virtual</span>
...
modifiable, and gives its type.</p><p>Virtual instance variables were added in version 3.10.</p><h4 class="subsubsection" id="sec197">Method definition</h4>
<p><a id="hevea_manual.kwd136"></a>
<a id="hevea_manual.kwd137"></a></p><p>A method definition is written <span class="c004">method</span> <a class="syntax" href="names.html#method-name"><span class="c010">method-name</span></a> <span class="c004">=</span> &nbsp;<a class="syntax" href="expr.html#expr"><span class="c010">expr</span></a>. The
...
…, &nbsp;<a class="syntax" href="expr.html#expr"><span class="c010">expr</span></a><sub><span class="c009">n</span></sub>.</p><h4 class="subsubsection" id="sec198">Virtual method definition</h4>
<p><a id="hevea_manual.kwd138"></a>
<a id="hevea_manual.kwd139"></a></p><p>A method specification is written <span class="c004">method</span> [<span class="c004">private</span>] <span class="c004">virtual</span>
...
polymorphic, the type must be explicitly polymorphic.</p><h4 class="subsubsection" id="sec199">Explicit overriding</h4>
...
Note that warning&nbsp;7 is disabled by default.</p><h4 class="subsubsection" id="sec200">Constraints on type parameters</h4>
<p><a id="hevea_manual.kwd140"></a>
...
expressions.</p><h4 class="subsubsection" id="sec201">Initializers</h4>
<p><a id="hevea_manual.kwd141"></a></p><p>A class initializer <span class="c004">initializer</span> <a class="syntax" href="expr.html#expr"><span class="c010">expr</span></a> specifies an expression that
will be evaluated whenever an object is created from the class, once
all its instance variables have been initialized.</p>
<h3 class="subsection" id="sec202">9.3&nbsp;&nbsp;Class definitions</h3>
<p>
<a id="s:classdef"></a></p><p><a id="hevea_manual.kwd142"></a>
<a id="hevea_manual.kwd143"></a></p><div class="syntax"><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
section&nbsp;<a href="types.html#s%3Asharp-types">7.4</a>).</p><h4 class="subsubsection" id="sec203">Virtual class</h4>
...
Objects cannot be created from a virtual class.</p><h4 class="subsubsection" id="sec204">Type parameters</h4>
...
<h3 class="subsection" id="sec205">9.4&nbsp;&nbsp;Class specifications</h3>
<p>
<a id="s:class-spec"></a></p><p><a id="hevea_manual.kwd144"></a>
<a id="hevea_manual.kwd145"></a></p><div class="syntax"><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
<h3 class="subsection" id="sec206">9.5&nbsp;&nbsp;Class type definitions</h3>
<p>
<a id="s:classtype"></a></p><p><a id="hevea_manual.kwd146"></a>
<a id="hevea_manual.kwd147"></a>
<a id="hevea_manual.kwd148"></a></p><div class="syntax"><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
<ul>
<li><a href="#sec208">10.1&nbsp;&nbsp;Simple module types</a>
</li><li><a href="#sec209">10.2&nbsp;&nbsp;Signatures</a>
</li><li><a href="#sec219">10.3&nbsp;&nbsp;Functor types</a>
</li><li><a href="#sec220">10.4&nbsp;&nbsp;The <span class="c003">with</span> operator</a>
</li></ul>
...
<h4 class="subsubsection" id="sec218">Including a signature</h4>
...
<ul>
<li><a href="#sec222">11.1&nbsp;&nbsp;Simple module expressions</a>
</li><li><a href="#sec223">11.2&nbsp;&nbsp;Structures</a>
</li><li><a href="#sec233">11.3&nbsp;&nbsp;Functors</a>
</li></ul>
