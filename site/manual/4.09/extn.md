...
elements in the arrays provided by the <a href="../../api/4.09/Bigarray.html"><span class="c003">Bigarray</span></a> module.</p><p>The short expressions are translated into calls to functions of the
...
</code><code class="caml-output error">Error: Cannot use private constructor Bool to create values of type Expr.attr
</code></pre>
...
</span></code><code class="caml-output ok">val sort : 'x list -&gt; 'x list = &lt;fun&gt;
</code></pre>
...
</code><code class="caml-output error">Error: The type t/3744 introduced by this open appears in the signature
