...
<h1 class="chapter" id="sec375"><span>Chapter 17</span>&nbsp;&nbsp;The debugger (ocamldebug)</h1>
<header><nav class="toc brand"><a class="brand" href="https://ocaml.org/"><img src="colour-logo-gray.svg" class="svg" alt="OCaml"></a></nav><nav class="toc"><div class="toc_version"><a href="/docs" id="version-select">Version 4.07</a></div><div class="toc_title"><a href="#">The debugger (ocamldebug)</a></div><ul><li class="top"><a href="#">Top</a></li>
<li><a href="debugger.html#sec376">1&nbsp;&nbsp;Compiling for debugging</a>
</li><li><a href="debugger.html#sec377">2&nbsp;&nbsp;Invocation</a>
</li><li><a href="debugger.html#sec381">3&nbsp;&nbsp;Commands</a>
</li><li><a href="debugger.html#sec384">4&nbsp;&nbsp;Executing a program</a>
</li><li><a href="debugger.html#sec390">5&nbsp;&nbsp;Breakpoints</a>
</li><li><a href="debugger.html#sec391">6&nbsp;&nbsp;The call stack</a>
</li><li><a href="debugger.html#sec392">7&nbsp;&nbsp;Examining variable values</a>
</li><li><a href="debugger.html#sec393">8&nbsp;&nbsp;Controlling the debugger</a>
</li><li><a href="debugger.html#sec402">9&nbsp;&nbsp;Miscellaneous commands</a>
</li><li><a href="debugger.html#sec403">10&nbsp;&nbsp;Running the debugger under Emacs</a>
</li></ul></nav></header>
<p> <a id="c:debugger"></a>
...
<h2 class="section" id="sec376">1&nbsp;&nbsp;Compiling for debugging</h2>
...
<h2 class="section" id="sec377">2&nbsp;&nbsp;Invocation</h2>
<h3 class="subsection" id="sec378">2.1&nbsp;&nbsp;Starting the debugger</h3>
...
<h3 class="subsection" id="sec379">2.2&nbsp;&nbsp;Initialization file</h3>
...
<h3 class="subsection" id="sec380">2.3&nbsp;&nbsp;Exiting the debugger</h3>
...
<h2 class="section" id="sec381">3&nbsp;&nbsp;Commands</h2>
...
<h3 class="subsection" id="sec382">3.1&nbsp;&nbsp;Getting help</h3>
...
<h3 class="subsection" id="sec383">3.2&nbsp;&nbsp;Accessing the debugger state</h3>
...
<h2 class="section" id="sec384">4&nbsp;&nbsp;Executing a program</h2>
<h3 class="subsection" id="sec385">4.1&nbsp;&nbsp;Events</h3>
...
<h3 class="subsection" id="sec386">4.2&nbsp;&nbsp;Starting the debugged program</h3>
...
<h3 class="subsection" id="sec387">4.3&nbsp;&nbsp;Running the program</h3>
...
<h3 class="subsection" id="sec388">4.4&nbsp;&nbsp;Time travel</h3>
...
<h3 class="subsection" id="sec389">4.5&nbsp;&nbsp;Killing the program</h3>
<dl class="description"><dt class="dt-description">
...
<h2 class="section" id="sec390">5&nbsp;&nbsp;Breakpoints</h2>
...
<h2 class="section" id="sec391">6&nbsp;&nbsp;The call stack</h2>
...
<h2 class="section" id="sec392">7&nbsp;&nbsp;Examining variable values</h2>
...
<h2 class="section" id="sec393">8&nbsp;&nbsp;Controlling the debugger</h2>
<h3 class="subsection" id="sec394">8.1&nbsp;&nbsp;Setting the program name and arguments</h3>
<dl class="description"><dt class="dt-description">
...
<h3 class="subsection" id="sec395">8.2&nbsp;&nbsp;How programs are loaded</h3>
...
<h3 class="subsection" id="sec396">8.3&nbsp;&nbsp;Search path for files</h3>
...
<h3 class="subsection" id="sec397">8.4&nbsp;&nbsp;Working directory</h3>
...
<h3 class="subsection" id="sec398">8.5&nbsp;&nbsp;Turning reverse execution on and off</h3>
...
<h3 class="subsection" id="sec399">8.6&nbsp;&nbsp;Communication between the debugger and the program</h3>
<p>
...
<h3 class="subsection" id="sec400">8.7&nbsp;&nbsp;Fine-tuning the debugger</h3>
...
<h3 class="subsection" id="sec401">8.8&nbsp;&nbsp;User-defined printers</h3>
...
<h2 class="section" id="sec402">9&nbsp;&nbsp;Miscellaneous commands</h2>
<dl class="description"><dt class="dt-description">
...
<h2 class="section" id="sec403">10&nbsp;&nbsp;Running the debugger under Emacs</h2>
