...
<h2 class="section" id="sec259">15&nbsp;&nbsp;Syntax for Bigarray access</h2>
...
<span class="c003">Bigarray</span>[<a href="../../api/4.07/Bigarray.html"><span class="c003">Bigarray</span></a>] library.</p><p>The short expressions are translated into calls to functions of the
...
<h2 class="section" id="sec260">16&nbsp;&nbsp;Attributes</h2>
...
<h3 class="subsection" id="sec261">16.1&nbsp;&nbsp;Built-in attributes</h3>
<p>
...
<h2 class="section" id="sec262">17&nbsp;&nbsp;Extension nodes</h2>
...
attributes&nbsp;<a href="#s%3Aattributes">8.16</a>.</p><p>The first form of extension node is used for “algebraic” categories:</p><div class="syntax"><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
<h3 class="subsection" id="sec263">17.1&nbsp;&nbsp;Built-in extension nodes</h3>
...
<h2 class="section" id="sec264">18&nbsp;&nbsp;Quoted strings</h2>
...
itself.</p><div class="syntax"><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
...
</tbody></table></div><p>The opening delimiter has the form <span class="c003">{id|</span> where <span class="c003">id</span> is a (possibly
...
<h2 class="section" id="sec265">19&nbsp;&nbsp;Exception cases in pattern matching</h2>
...
are rejected by the type-checker).</p><div class="syntax"><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
<a class="syntax" href="patterns.html#pattern"><span class="c010">pattern</span></a></td><td class="c015">::=</td><td class="c017">&nbsp;...
&nbsp;</td></tr>
...
</tbody></table></div><p>Cases with such a toplevel pattern are called “exception cases”,
...
matching.</p>
<h2 class="section" id="sec266">20&nbsp;&nbsp;Extensible variant types</h2>
...
<h3 class="subsection" id="sec267">20.1&nbsp;&nbsp;Private extensible variant types</h3>
...
<h2 class="section" id="sec268">21&nbsp;&nbsp;Generative functors</h2>
...
<h2 class="section" id="sec269">22&nbsp;&nbsp;Extension-only syntax</h2>
<p>
...
<h3 class="subsection" id="sec270">22.1&nbsp;&nbsp;Extension operators</h3>
<p> <a id="s:ext-ops"></a>
...
<h3 class="subsection" id="sec271">22.2&nbsp;&nbsp;Extension literals</h3>
...
<h2 class="section" id="sec272">23&nbsp;&nbsp;Inline records</h2>
...
</tbody></table></div><p>The arguments of a sum-type constructors can now be defined using the
...
<h2 class="section" id="sec273">24&nbsp;&nbsp;Local exceptions</h2>
<p>
<a id="hevea_manual.kwd230"></a>
<a id="hevea_manual.kwd231"></a> <a id="s:local-exceptions"></a></p><p>(Introduced in OCaml 4.04)</p><p>It is possible to define local exceptions in expressions:</p><div class="syntax"><table class="display dcenter"><tbody><tr class="c019"><td class="dcell"><table class="c001 cellpading0"><tbody><tr><td class="c018">
<a class="syntax" href="expr.html#expr"><span class="c010">expr</span></a></td><td class="c015">::=</td><td class="c017">
...
&nbsp;</td></tr>
...
</tbody></table></div><p>The syntactic scope of the exception constructor is the inner
...
<h2 class="section" id="sec274">25&nbsp;&nbsp;Documentation comments</h2>
<p>
...
<h3 class="subsection" id="sec275">25.1&nbsp;&nbsp;Floating comments</h3>
...
<h3 class="subsection" id="sec276">25.2&nbsp;&nbsp;Item comments</h3>
...
<h3 class="subsection" id="sec277">25.3&nbsp;&nbsp;Label comments</h3>
...
<h2 class="section" id="s:empty-variants">27&nbsp;&nbsp;Empty variant types </h2>
<p>
