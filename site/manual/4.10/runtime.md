...
<h1 class="chapter" id="sec305"><span>Chapter 11</span>&nbsp;&nbsp;The runtime system (ocamlrun)</h1>
<header><nav class="toc brand"><a class="brand" href="https://ocaml.org/"><img src="colour-logo-gray.svg" class="svg" alt="OCaml"></a></nav><nav class="toc"><div class="toc_version"><a href="/docs" id="version-select">Version 4.10</a></div><div class="toc_title"><a href="#">The runtime system (ocamlrun)</a></div><ul><li class="top"><a href="#">Top</a></li>
<li><a href="runtime.html#s%3Aocamlrun-overview">1&nbsp;&nbsp;Overview</a>
</li><li><a href="runtime.html#s%3Aocamlrun-options">2&nbsp;&nbsp;Options</a>
</li><li><a href="runtime.html#s%3Aocamlrun-dllpath">3&nbsp;&nbsp;Dynamic loading of shared libraries</a>
</li><li><a href="runtime.html#s%3Aocamlrun-common-errors">4&nbsp;&nbsp;Common errors</a>
</li></ul></nav></header>
<p> <a id="c:runtime"></a>
...
<h2 class="section" id="s:ocamlrun-overview"><a class="section-anchor" href="#s:ocamlrun-overview" aria-hidden="true"></a>1&nbsp;&nbsp;Overview</h2>
...
<h2 class="section" id="s:ocamlrun-options"><a class="section-anchor" href="#s:ocamlrun-options" aria-hidden="true">﻿</a>2&nbsp;&nbsp;Options</h2>
<p>
...
<a href="../../api/4.10/Gc.html">Module <span class="c003">Gc</span></a>.
...
(see
<a href="../../api/4.10/Hashtbl.html">Module <span class="c003">Hashtbl</span></a>).
This option takes no argument.
...
<h2 class="section" id="s:ocamlrun-dllpath"><a class="section-anchor" href="#s:ocamlrun-dllpath" aria-hidden="true">﻿</a>3&nbsp;&nbsp;Dynamic loading of shared libraries</h2>
...
<h2 class="section" id="s:ocamlrun-common-errors"><a class="section-anchor" href="#s:ocamlrun-common-errors" aria-hidden="true">﻿</a>4&nbsp;&nbsp;Common errors</h2>
