...
<h1 class="chapter" id="sec319"><span>Chapter 13</span>&nbsp;&nbsp;Lexer and parser generators (ocamllex, ocamlyacc)</h1>
<header><nav class="toc brand"><a class="brand" href="https://ocaml.org/"><img src="colour-logo-gray.svg" class="svg" alt="OCaml"></a></nav><nav class="toc"><div class="toc_version"><a href="/docs" id="version-select">Version 4.10</a></div><div class="toc_title"><a href="#">Lexer and parser generators (ocamllex, ocamlyacc)</a></div><ul><li class="top"><a href="#">Top</a></li>
<li><a href="lexyacc.html#s%3Aocamllex-overview">1&nbsp;&nbsp;Overview of <span class="c003">ocamllex</span></a>
</li><li><a href="lexyacc.html#s%3Aocamllex-syntax">2&nbsp;&nbsp;Syntax of lexer definitions</a>
</li><li><a href="lexyacc.html#s%3Aocamlyacc-overview">3&nbsp;&nbsp;Overview of <span class="c003">ocamlyacc</span></a>
</li><li><a href="lexyacc.html#s%3Aocamlyacc-syntax">4&nbsp;&nbsp;Syntax of grammar definitions</a>
</li><li><a href="lexyacc.html#s%3Aocamlyacc-options">5&nbsp;&nbsp;Options</a>
</li><li><a href="lexyacc.html#s%3Alexyacc-example">6&nbsp;&nbsp;A complete example</a>
</li><li><a href="lexyacc.html#s%3Alexyacc-common-errors">7&nbsp;&nbsp;Common errors</a>
</li></ul></nav></header>
<p>
<a id="c:ocamlyacc"></a>
...
<h2 class="section" id="s:ocamllex-overview"><a class="section-anchor" href="#s:ocamllex-overview" aria-hidden="true"></a>1&nbsp;&nbsp;Overview of <span class="c003">ocamllex</span></h2>
...
<span class="c003">Lexing</span> in chapter&nbsp;<a href="stdlib.html#c%3Astdlib">25</a>.)</p><p>When used in conjunction with a parser generated by <span class="c003">ocamlyacc</span>, the
...
below.)</p>
<h3 class="subsection" id="ss:ocamllex-options"><a class="section-anchor" href="#ss:ocamllex-options" aria-hidden="true">﻿</a>1.1&nbsp;&nbsp;Options</h3>
<p>
...
<h2 class="section" id="s:ocamllex-syntax"><a class="section-anchor" href="#s:ocamllex-syntax" aria-hidden="true">﻿</a>2&nbsp;&nbsp;Syntax of lexer definitions</h2>
...
<h3 class="subsection" id="ss:ocamllex-header-trailer"><a class="section-anchor" href="#ss:ocamllex-header-trailer" aria-hidden="true">﻿</a>2.1&nbsp;&nbsp;Header and trailer</h3>
<p>
...
actions.</p>
<h3 class="subsection" id="ss:ocamllex-named-regexp"><a class="section-anchor" href="#ss:ocamllex-named-regexp" aria-hidden="true">﻿</a>2.2&nbsp;&nbsp;Naming regular expressions</h3>
...
<h3 class="subsection" id="ss:ocamllex-entry-points"><a class="section-anchor" href="#ss:ocamllex-entry-points" aria-hidden="true">﻿</a>2.3&nbsp;&nbsp;Entry points</h3>
...
<h3 class="subsection" id="ss:ocamllex-regexp"><a class="section-anchor" href="#ss:ocamllex-regexp" aria-hidden="true">﻿</a>2.4&nbsp;&nbsp;Regular expressions</h3>
...
<h3 class="subsection" id="ss:ocamllex-actions"><a class="section-anchor" href="#ss:ocamllex-actions" aria-hidden="true">﻿</a>2.5&nbsp;&nbsp;Actions</h3>
...
<h3 class="subsection" id="ss:ocamllex-variables"><a class="section-anchor" href="#ss:ocamllex-variables" aria-hidden="true">﻿</a>2.6&nbsp;&nbsp;Variables in regular expressions</h3>
<p>
...
<h3 class="subsection" id="ss:refill-handlers"><a class="section-anchor" href="#ss:refill-handlers" aria-hidden="true">﻿</a>2.7&nbsp;&nbsp;Refill handlers</h3>
...
<h3 class="subsection" id="ss:ocamllex-reserved-ident"><a class="section-anchor" href="#ss:ocamllex-reserved-ident" aria-hidden="true">﻿</a>2.8&nbsp;&nbsp;Reserved identifiers</h3>
...
<h2 class="section" id="s:ocamlyacc-overview"><a class="section-anchor" href="#s:ocamlyacc-overview" aria-hidden="true">﻿</a>3&nbsp;&nbsp;Overview of <span class="c003">ocamlyacc</span></h2>
...
<h2 class="section" id="s:ocamlyacc-syntax"><a class="section-anchor" href="#s:ocamlyacc-syntax" aria-hidden="true">﻿</a>4&nbsp;&nbsp;Syntax of grammar definitions</h2>
...
<h3 class="subsection" id="ss:ocamlyacc-header-trailer"><a class="section-anchor" href="#ss:ocamlyacc-header-trailer" aria-hidden="true">﻿</a>4.1&nbsp;&nbsp;Header and trailer</h3>
...
<h3 class="subsection" id="ss:ocamlyacc-declarations"><a class="section-anchor" href="#ss:ocamlyacc-declarations" aria-hidden="true">﻿</a>4.2&nbsp;&nbsp;Declarations</h3>
...
<h3 class="subsection" id="ss:ocamlyacc-rules"><a class="section-anchor" href="#ss:ocamlyacc-rules" aria-hidden="true">﻿</a>4.3&nbsp;&nbsp;Rules</h3>
...
<h3 class="subsection" id="ss:ocamlyacc-error-handling"><a class="section-anchor" href="#ss:ocamlyacc-error-handling" aria-hidden="true">﻿</a>4.4&nbsp;&nbsp;Error handling</h3>
...
<h2 class="section" id="s:ocamlyacc-options"><a class="section-anchor" href="#s:ocamlyacc-options" aria-hidden="true">﻿</a>5&nbsp;&nbsp;Options</h2>
...
<h2 class="section" id="s:lexyacc-example"><a class="section-anchor" href="#s:lexyacc-example" aria-hidden="true">﻿</a>6&nbsp;&nbsp;A complete example</h2>
...
<h2 class="section" id="s:lexyacc-common-errors"><a class="section-anchor" href="#s:lexyacc-common-errors" aria-hidden="true">﻿</a>7&nbsp;&nbsp;Common errors</h2>
