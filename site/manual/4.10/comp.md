...
<h1 class="chapter" id="sec287"><span>Chapter 9</span>&nbsp;&nbsp;Batch compilation (ocamlc)</h1>
<header><nav class="toc brand"><a class="brand" href="https://ocaml.org/"><img src="colour-logo-gray.svg" class="svg" alt="OCaml"></a></nav><nav class="toc"><div class="toc_version"><a href="/docs" id="version-select">Version 4.10</a></div><div class="toc_title"><a href="#">Batch compilation (ocamlc)</a></div><ul><li class="top"><a href="#">Top</a></li>
<li><a href="comp.html#s%3Acomp-overview">1&nbsp;&nbsp;Overview of the compiler</a>
</li><li><a href="comp.html#s%3Acomp-options">2&nbsp;&nbsp;Options</a>
</li><li><a href="comp.html#s%3Amodules-file-system">3&nbsp;&nbsp;Modules and the file system</a>
</li><li><a href="comp.html#s%3Acomp-errors">4&nbsp;&nbsp;Common errors</a>
</li><li><a href="comp.html#s%3Acomp-warnings">5&nbsp;&nbsp;Warning reference</a>
</li></ul></nav></header>
<p> <a id="c:camlc"></a>
...
<h2 class="section" id="s:comp-overview"><a class="section-anchor" href="#s:comp-overview" aria-hidden="true"></a>1&nbsp;&nbsp;Overview of the compiler</h2>
...
<h2 class="section" id="s:comp-options"><a class="section-anchor" href="#s:comp-options" aria-hidden="true">﻿</a>2&nbsp;&nbsp;Options</h2>
<p>The following command-line options are recognized by <span class="c003">ocamlc</span>.
...
See section&nbsp;<a href="intfc.html#ss%3Acustom-runtime">20.1.6</a> for more information.
...
<h2 class="section" id="s:modules-file-system"><a class="section-anchor" href="#s:modules-file-system" aria-hidden="true">﻿</a>3&nbsp;&nbsp;Modules and the file system</h2>
...
files by hand.</p>
<h2 class="section" id="s:comp-errors"><a class="section-anchor" href="#s:comp-errors" aria-hidden="true">﻿</a>4&nbsp;&nbsp;Common errors</h2>
...
<h2 class="section" id="s:comp-warnings"><a class="section-anchor" href="#s:comp-warnings" aria-hidden="true">﻿</a>5&nbsp;&nbsp;Warning reference</h2>
<p>This section describes and explains in detail some warnings:</p>
<h3 class="subsection" id="ss:warn9"><a class="section-anchor" href="#ss:warn9" aria-hidden="true">﻿</a>5.1&nbsp;&nbsp;Warning 9: missing fields in a record pattern</h3>
...
<h3 class="subsection" id="ss:warn52"><a class="section-anchor" href="#ss:warn52" aria-hidden="true">﻿</a>5.2&nbsp;&nbsp;Warning 52: fragile constant pattern</h3>
<p>Some constructors, such as the exception constructors <span class="c003">Failure</span> and
...
using the <span class="c003">exception</span> patterns documented in Section&nbsp;<a href="patterns.html#sss%3Aexception-match">7.6</a>,
one can write:
...
<h3 class="subsection" id="ss:warn57"><a class="section-anchor" href="#ss:warn57" aria-hidden="true">﻿</a>5.3&nbsp;&nbsp;Warning 57: Ambiguous or-pattern variables under guard</h3>
