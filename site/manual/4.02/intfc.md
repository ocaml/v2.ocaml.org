...
<li><a href="#sec414">Overview and compilation information</a>
</li><li><a href="#sec421">The <span class="c007">value</span> type</a>
</li><li><a href="#sec425">Representation of OCaml data types</a>
</li><li><a href="#sec432">Operations on values</a>
</li><li><a href="#sec440">Living in harmony with the garbage collector</a>
</li><li><a href="#sec447">A complete example</a>
</li><li><a href="#sec448">Advanced topic: callbacks from C to OCaml</a>
</li><li><a href="#sec457">Advanced example with callbacks</a>
</li><li><a href="#sec458">Advanced topic: custom blocks</a>
</li><li><a href="#sec465">Advanced topic: multithreading</a>
</li><li><a href="#sec468">Building mixed C/OCaml libraries: <span class="c007">ocamlmklib</span></a>
</li></ul></nav></header>
...
below).</p>
<h3 class="subsection" id="sec436">4.4&nbsp;&nbsp;Allocating blocks</h3>
...
<h3 class="subsection" id="sec460">9.2&nbsp;&nbsp;Allocating custom blocks</h3>
...
<h3 class="subsection" id="sec461">9.3&nbsp;&nbsp;Accessing custom blocks</h3>
...
<h3 class="subsection" id="sec462">9.4&nbsp;&nbsp;Writing custom serialization and deserialization functions</h3>
...
written on a little-endian machine and read back on a big-endian machine.</p><div class="center"><table class="c001 cellpadding1" border="1"><tbody><tr><td class="c021"><span class="c019">Function</span></td><td class="c021"><span class="c019">Action</span> </td></tr>
<tr><td class="c029">
...
<h3 class="subsection" id="sec463">9.5&nbsp;&nbsp;Choosing identifiers</h3>
...
<h3 class="subsection" id="sec464">9.6&nbsp;&nbsp;Finalized blocks</h3>
...
<h2 class="section" id="sec465">10&nbsp;&nbsp;Advanced topic: multithreading</h2>
<p>
...
section.</p>
<h3 class="subsection" id="sec466">10.1&nbsp;&nbsp;Registering threads created from C</h3>
...
<h3 class="subsection" id="sec467">10.2&nbsp;&nbsp;Parallel execution of long-running C code</h3>
...
<h2 class="section" id="sec468">11&nbsp;&nbsp;Building mixed C/OCaml libraries: <span class="c007">ocamlmklib</span></h2>
<p>
...
<h5 class="paragraph" id="sec469">Example</h5>
