...
<div class="container">
    ...
    <div class="row">
        ...
        <section id="learn-leader" class="span7">
            <h1>What is OCaml?</h1>
            <p>OCaml is a general purpose industrial-strength programming language with an emphasis on expressiveness and safety. <a href="/learn/companies.html">Used</a> in environments where a single mistake can cost millions and speed matters, it is supported by an <a href="/community">active community</a> that has developed a <a href="https://opam.ocaml.org">rich set of libraries</a>. <small><em><a href="/learn/description.html">Read more</a></em></small>.</p>
        </section>
